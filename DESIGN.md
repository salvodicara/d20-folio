...
| `public/assets/backgrounds/sheet-plate.webp` (PENDING)                          | ≥2304×3456, < 320 KB | The character sheet's DARK working plate (`--asset-sheet-plate`) — the two-style law's cockpit material (PROMPT_26): BG3-examine smoky umber, top ≈ srgb(32,28,25) → foot ≈ srgb(19,14,11), σ<6, portrait. **Owner to generate.**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `public/assets/backgrounds/sheet-plate-light.webp` (PENDING)                    | ≥2304×3456, < 320 KB | The daylight sibling (PROMPT_27): pale buff leather/wood band #ded2bc→#c9bda6, σ<6 — never parchment (that is the compendium's register). **Owner to generate.**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| (REGEN queued) `parchment.webp` + `vellum-dark.webp`                            | ≥3344×1882 each      | 2× remasters of the shipped tome leaves (PROMPT_28/29) under the anti-grain law — same subjects, same grades, more pixels; swapped in place, no CSS change. **Owner to generate.**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
3. **Parchment** (the reading register — compendium tome, book spreads): the `#e0d0b0/#d0c0a0`
   ...
   **TWO-STYLE LAW (owner, 2026-08-01 — "due stili distinti come BG3, niente compromessi"):**
   ...
   wears its OWN working-register plate, **CSS-BUILT** (`.sheet-plate` material, folio.css):
