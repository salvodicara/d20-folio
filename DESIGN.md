...
- **Provenance.** The plates are **owner-generated** from orchestrator-authored prompts, delivered
  ...
  `~/Documents/d20-folio-bg3-asset-prompts.md`) — P12–P19 shipped so far: the v2 repaints of all
  three scene-plate pairs (study pair, login pair, war-table campaign pair) at BG3 main-menu
  richness (same rooms, richly painted edges, calm centres preserved), plus the first NEW realm
  scene — the compendium's Grand Library pair (P18–P19).
