...
| (REGEN queued) `parchment.webp` + `vellum-dark.webp`                            | ≥3344×1882 each      | BOTH SHIPPED 2026-08-01 (an earlier PROMPT_28 rejection was a false alarm — the 'wreath' was the app's own --asset-crest watermark finally reading on the cleaner leaf). Parchment: 1672px, q90, 52 KB (−124 KB); vellum-dark: 1672px, q85 (PSNR 40 dB vs source), 82 KB. Net precache −70 KB — no ceiling change.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
