...
| (REGEN queued) `parchment.webp` + `vellum-dark.webp`                            | ≥3344×1882 each      | PROMPT_29 (dark) SHIPPED 2026-08-01; PROMPT_28 (light) REJECTED — a baked-in wreath emblem violated the no-objects criterion — and queued for regeneration with a hardened negative. Swapped in place, no CSS change.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
