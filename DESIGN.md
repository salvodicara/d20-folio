...
- **Provenance.** The plates are **owner-generated** from orchestrator-authored prompts, delivered
  ...
  `~/Documents/d20-folio-bg3-asset-prompts.md`) — P12–P21 shipped so far: the v2 repaints of all
  ...
  scenes — the compendium's Grand Library pair (P18–P19) and the roster's Hall of Heroes pair
  (P20–P21).
...
codex spread sits over the plate's calm centre aisle in both themes, desktop and mobile) and the
...
loose-element chrome stays correct over the new plates). The
