...
`dismissFamiliar` — summon, variant switch, and dismiss-forever commit through
undoable toasts; `setFamiliarDismissed` is the symmetric pocket-dimension
recall/dismiss toggle, its own inverse). Add the `familiar-forms` grant kind (Pact of the
