...
## Summary
- 31136 nodes · 41794 edges · 3208 communities (2623 shown, 585 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 3336 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0af10d16`
...
## Communities (3208 total, 585 thin omitted)
...
Cohesion: 0.03
Nodes (154): RestFlow(), abilityModifier(), acFromAggregate(), aggregationActiveKeys(), AggregationSession, computeCharacterAC(), computeCharacterAcBreakdown(), computeCharacterMaxHp() (+146 more)
...
Cohesion: 0.03
Nodes (131): AdvancedCollection, advancedFields(), advancedRowFields(), AdvancedRowKind, b(), blankAdvancedRow(), declaredProgramCosts(), f() (+123 more)
...
Cohesion: 0.04
Nodes (91): catalogueSnapshot(), catalogueSource(), families, leafDefinition(), creationPool(), proficientWeapon(), resolveCreationPool(), snapshots (+83 more)
...
Cohesion: 0.04
Nodes (81): RetainedCreation, StoragePort, ImportDraft, parseImportDraft(), createImportRepository(), ImportOperation, ImportReceipt, ImportReconciliation (+73 more)
...
Cohesion: 0.03
Nodes (75): MovementSlider(), MovementSliderProps, snapClamp(), EconFilterType, ThisTurnTracker(), advanceSharedTurn(), combatantUid(), observedOwnerBoundary() (+67 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (89): AbilityIssue, checkCreationAbilities(), CreationMethod, CreationScores, POINT_COST, STANDARD_SCORES, active(), creationCandidate() (+81 more)

### Community 34 - "Community 34"
Cohesion: 0.06
Nodes (85): exactReceipt(), parseCreationDraft(), budget(), createCreationRepository(), CreationOperation, CreationReceipt, CreationRepository, CreationValidation (+77 more)
...
Cohesion: 0.04
Nodes (69): monsterInstanceName(), InitVital(), CombatantCard(), CombatWrite, EncounterStatblockModal, HpVital(), MonsterCard(), MonsterHpControl() (+61 more)

### Community 38 - "Community 38"
Cohesion: 0.06
Nodes (94): isEffectOccurrence(), resolveOccurrenceAuthority(), inventoryGenerationRefKey(), activeInventorySourceKeys(), allocateTimelineBoundary(), beginMechanicsBoundaryFromCausalState(), beginMechanicsBoundaryFromState(), betweenTurnsEconomy() (+86 more)
...
Cohesion: 0.03
Nodes (81): label(), classFeatureIndex, classFeatures, classTableIndex, classTables, getClassFeatures(), getClassTable(), getFeaturesAtLevel() (+73 more)
...
Cohesion: 0.02
Nodes (78): AcFormula, ActivatableGroup, AdvantageClause, AggregatedGrants, ATTACK_CLAUSE_SCOPES, AttackClauseScope, AtWillCastEntry, AURA_AFFECTS (+70 more)

### Community 44 - "Community 44"
Cohesion: 0.02
Nodes (92): abilityMapSchema, abilitySchema, ACTION_BASE, actionSchema, answerSchema, answersSchema, areaShapeSchema, automationSchema (+84 more)
...
Cohesion: 0.03
Nodes (75): CreationWizard(), applyExpertisePicks(), EXPERTISE_FEATURE_IDS, listExpertiseEligibleSkills(), arePicksComplete(), applyExpertiseChoicePicks(), ExpertiseChoicePicks, ExpertiseChoiceSlot (+67 more)
...
Cohesion: 0.04
Nodes (80): creatureVitalsFor(), directConditionInstances(), documentFor(), projectEntityConditions(), projectResolvedEntityConditions(), resolvedEntityConditions(), blueprintEntityKey(), causesFor() (+72 more)
...
Cohesion: 0.04
Nodes (78): PcCombatantCard(), derivePartyMemberStats(), derivePcLive(), hydrateMemberDoc(), PartyMemberSave, PartyMemberStats, dumpSheet(), aggregateCharacterGrants() (+70 more)

### Community 56 - "Community 56"
Cohesion: 0.07
Nodes (81): conformDiceFormula(), ABILITY_CODES, allOccurrenceRefsResolve(), ARMOR_CATEGORIES, CharacterMaterialRef, conformInventoryInstance(), conformMaterialEntity(), conformNewInventoryInstance() (+73 more)
...
Cohesion: 0.06
Nodes (72): authenticReviewedIntents, bindingsFor(), canonicalResourceCandidates(), characterMaterialRef(), comparison(), compilationPredicateContext(), conformAnswersStructure, conformIntentStructure (+64 more)

### Community 66 - "Community 66"
Cohesion: 0.03
Nodes (56): auraEffectLine(), ChoiceResistancePicker(), RailTracker(), FeatureGroup, trackerRecovery(), byId, loggedName(), RAW (+48 more)

### Community 67 - "Community 67"
Cohesion: 0.03
Nodes (46): fmtMod(), InputAnswer, ItemResourceCommandProvider(), PendingInput, CommittedItemResourceBoundary, CommittedItemResourceCommand, createItemResourcePaymentCycle(), ItemResourceCommandApi (+38 more)
...
Cohesion: 0.03
Nodes (46): abilityMod(), applyStartingForm(), buildDevRosterDocs(), buildDevScenario(), buildScenario(), DEV_SCENARIOS, devPortrait(), PUBLIC_SCENARIOS (+38 more)
...
Cohesion: 0.06
Nodes (65): advanceSoloWorldTurn(), endSoloWorldEncounter(), enteredInitiativeRoll(), soloWorldFor(), reverseEngineAction(), restThroughWorld(), runDamageReactionEntry(), undoDamageReactionEntry() (+57 more)

### Community 74 - "Community 74"
Cohesion: 0.07
Nodes (67): answerNumber(), answerPosition(), AreaResolution, areaShapeFrom(), applyHealing(), EndResult, assertNever(), EffectId (+59 more)

### Community 75 - "Community 75"
Cohesion: 0.06
Nodes (48): asRaceId(), asAlignmentId(), assertNonEmptyString(), nonEmptyString, mkDruid(), mk(), mk(), MkOpts (+40 more)

### Community 76 - "Community 76"
Cohesion: 0.04
Nodes (29): customInstanceId(), ringOfProtection(), SCORES, portraitToDataUrl, reimport(), concentrationWorld(), rawWorld(), vitalsDoc() (+21 more)

### Community 77 - "Community 77"
Cohesion: 0.05
Nodes (53): ArmorCard, ArmorCardCallbacks, ArmorCardProps, ChargeUse(), GearCard, GearCardCallbacks, GearCardProps, damageTypeAbbr() (+45 more)
...
Cohesion: 0.04
Nodes (49): actionAtCastLevel(), replaceBaseFormula(), ScalableCombatSummary, scaleCombatSummaryAtCastLevel(), avatarTint(), castingTimeI18nKey(), displayAc(), formatWeight() (+41 more)
...
Cohesion: 0.05
Nodes (62): deleteCampaign(), dmNotesCollection(), notesCollection(), loadSharedCharacter(), collection(), stampEffectiveAc(), mergeActiveCombatEffects(), AdminCampaignSummary (+54 more)

### Community 83 - "Community 83"
Cohesion: 0.05
Nodes (49): createEmptyCharacterMaterialState(), reviewMechanicsIntent(), beginMechanicsCausalState(), isMechanicsWorld(), parseMechanicsWorld(), validateClosedTurnState(), CHARACTER, count() (+41 more)
...
Cohesion: 0.07
Nodes (57): auditCombatState(), auditDocument(), auditEnvelope(), auditLibrary(), auditPortableExport(), AuditVerdict, classify(), classifyPath() (+49 more)

### Community 86 - "Community 86"
Cohesion: 0.03
Nodes (42): MobileDisclosure(), cn(), BreakdownTip(), BreakdownTipProps, RUBRIC_KEY, WhyProse(), ChoicePickerCard(), ChoicePickerCardProps (+34 more)
...
Cohesion: 0.06
Nodes (37): PLAY_REF_ANCHOR, PLAY_REF_SECTIONS, PlayRefSection, PlayRefDeepLink(), ReferenceSection(), TAB_DEFS, TabDef, TabBody() (+29 more)

### Community 93 - "Community 93"
Cohesion: 0.05
Nodes (39): CampaignCard(), partyLevelRange(), campaignMemberCount(), campaignPartySize(), CampaignState, mergeSharedNotes(), treasuryTotalCp(), treasuryTotalGp() (+31 more)

### Community 94 - "Community 94"
Cohesion: 0.06
Nodes (46): checkpointThrough(), compact(), ENCODER, encounterBytes(), pruneRolls(), shouldCompact(), throughNow(), EncounterParse (+38 more)
...
Cohesion: 0.13
Nodes (55): conformEntityRef(), checkpointStateValid(), completionStateValid(), completionWorld(), conformBoundaryCursor(), conformBoundaryEncounterCursor(), conformBoundaryParticipantCursor(), conformEncounterSeed() (+47 more)
...
Cohesion: 0.07
Nodes (46): buildCatalogue(), Catalogue, CatalogueError, mechanicOf(), programOf(), coverageFor(), CoverageRow, CoverageStatus (+38 more)

### Community 107 - "Community 107"
Cohesion: 0.06
Nodes (47): getSubclassFeatures(), HitDie, HpClassContribution, inferBgFeat(), inferHitDie(), inferHpMax(), inferSavingThrows(), inferSpeed() (+39 more)
...
Cohesion: 0.06
Nodes (28): CampaignInvite(), CreateCampaignModal(), inviteLinkFromCode(), HoverTip(), useSheetExport(), BinderFob(), tipBody(), MobileSignet() (+20 more)

### Community 110 - "Community 110"
Cohesion: 0.06
Nodes (46): CONDITION_ICONS, StatusLedge(), hasSrd(), IS_PROD, localizeSrd(), localizeSrdList(), missing(), proseCorpus() (+38 more)
...
Cohesion: 0.08
Nodes (40): redactIdentifiers(), captureScreenshot(), downscale(), Screenshot, toBlob(), collectDebugContext(), DebugContext, g (+32 more)
...
Cohesion: 0.05
Nodes (37): fmt(), localeRangePair(), CharacterIdentityLine(), Props, EditableInput(), localizeAlignment(), ORIGIN_FEATS, SrdBackgroundSelect() (+29 more)
...
Cohesion: 0.09
Nodes (39): I18N_ROOT, mergedUi(), PACK_I18N_ROOT, readShard(), shardNames(), srdCatalogue(), srdCatalogueNames(), uiNamespaces() (+31 more)
...
Cohesion: 0.07
Nodes (34): listSharedCampaigns(), readDevCampaign(), subscribeToSharedCampaigns(), DEV_PIP_EPOCHS, DEV_PIP_INIT_TABLES, devEmpty(), devEncounterInitSeed(), devPcEntry() (+26 more)
...
Cohesion: 0.11
Nodes (31): validResourceId(), defaultPreparedState(), integer(), keys(), materializePreparedCopy(), parsePreparationVersion(), parsePreparedCopy(), parsePreparedState() (+23 more)
...
Cohesion: 0.09
Nodes (38): ABILITIES, automaticOutcome(), boundedUniqueSources(), conformD20TestObservation(), conformD20TestRequest(), conformObservationStructure, conformRequestStructure, D20_SCHEMA_CONTEXT (+30 more)
...
Cohesion: 0.09
Nodes (29): CmpSeal(), CompendiumDetailBody(), CompendiumVerdict, FilterGroup, Locale, PickerDetailView, PickerRowView, RowState (+21 more)
...
Cohesion: 0.07
Nodes (37): diceCount(), DiceTerm, DIE_SIDES, DIE_SIDES_SET, DieSides, evaluate(), EvaluatedTerm, Evaluation (+29 more)

### Community 149 - "Community 149"
Cohesion: 0.10
Nodes (39): acceptedTrailFace(), addBounds(), aggregateId(), conformAcceptancePolicyStructure, conformDiceAcceptancePolicy(), conformDiceObservation(), conformDiceReplacementPolicy(), conformDiceResolution() (+31 more)
...
Cohesion: 0.10
Nodes (23): BrowserProps, CompendiumBrowser(), EntryView(), EntryViewProps, CompendiumFacets(), FacetsProps, useActiveTabScroll(), CompendiumPicker() (+15 more)

### Community 153 - "Community 153"
Cohesion: 0.10
Nodes (40): conformMechanicsProgram(), conformProgramStructure, allOf(), attackInput(), attackLanded(), attackOutcomeSelector(), CANONICAL_ROLL_RULES, cantripScaledCount() (+32 more)
...
Cohesion: 0.09
Nodes (27): acquisition, creationFlowKey(), flow, AccountNavigation(), IdentityAccount(), AuthenticatedIdentity(), IdentityNavigation(), NavigationContext (+19 more)
...
Cohesion: 0.09
Nodes (29): advanceTurn(), deadMonsterIds(), EncounterPcSeed, encounterRollFor(), finiteNumber(), hasOnlyKeys(), isEncounterMonster(), isEncounterPc() (+21 more)

### Community 162 - "Community 162"
Cohesion: 0.09
Nodes (32): BYSTANDER, { catalogue }, DM, fogged(), P1, P2, run(), table() (+24 more)

### Community 163 - "Community 163"
Cohesion: 0.09
Nodes (27): INITIAL, BgAsiPicker(), CLASS_ROLE_FALLBACK, CLASS_ROLE_IDS, CLASS_ROLES, ClassIcon, ClassRole, classRoleSeal() (+19 more)

### Community 164 - "Community 164"
Cohesion: 0.07
Nodes (33): decodeEnvelope(), validateCharacterData(), inferFeatures(), inferSpellcasting(), ABILITY_CODES, BARE_SPELL_KEYS, canonicalizeForCompare(), DERIVABLE (+25 more)
...
Cohesion: 0.07
Nodes (34): applyActionConcentration(), ConcentrationSavePrompt(), confirmConcentrationSwap(), localizeCustom(), CharacterConcentrationSaveD20Context, CharacterD20ContextBase, CharacterD20ModifierTerm, CharacterD20TestContext (+26 more)
...
Cohesion: 0.08
Nodes (34): reviewedPaymentsAreAffordable(), characterParts(), conformInitializationObservationsStructure, conformResourceOperation(), conformResourceOperationStructure, conformResourceRecoveryTrigger(), conformResourceRef(), conformResourceRefStructure (+26 more)
...
Cohesion: 0.08
Nodes (28): saves(), CR_VALUES, monsterInitiative(), monsterPassivePerception(), monsterSaveBonus(), monsterSkillBonus(), pbForCr(), XP_BY_CR (+20 more)
...
Cohesion: 0.09
Nodes (27): remainingMovement(), EconomyPill(), EconomyPillProps, ROMAN, SIGNS, Hotbar(), HotbarProps, initials() (+19 more)
...
Cohesion: 0.08
Nodes (25): MapViewportApi, InitiativeStrip(), InitiativeStripProps, StripCell, conditionName(), createPlayLabels(), monsterLabelId(), PlayLabelArgs (+17 more)

### Community 198 - "Community 198"
Cohesion: 0.10
Nodes (21): CONTENT_PACK_ENTRY, CONTENT_PACK_ITEM_ART_ENTRY, CONTENT_PACK_MONSTER_ART_ENTRY, CONTENT_PACK_MONSTERS_ENTRY, contentPackEnabled(), fsAllowRoots(), PACK_EMPTY_ENTRY, packAliasTarget() (+13 more)
...
Cohesion: 0.07
Nodes (28): hasActiveSpendOwner(), attunementSatisfied(), EquipRef, requiresAttunement(), isArmorProficient(), resolveArmorEffects(), featPrereqMet(), potionDurationRounds() (+20 more)
...
Cohesion: 0.09
Nodes (28): firstOf(), authorsOf(), { catalogue }, Client, compactAndVerify(), converge(), entityOf(), EVERYONE (+20 more)
...
Cohesion: 0.08
Nodes (18): AdminCharIndex, AdminMatchHint, AdminSearchUser, buildAdminMatches(), AdminUser, campaignTallies(), formatDate(), RosterState (+10 more)
...
Cohesion: 0.12
Nodes (27): storedCharacterConcentration(), conformActiveCombatEffects(), conformCombatEffectOp(), isActiveCombatEffect(), isCombatantRef(), isCombatEffectDuration(), isRecord(), isString() (+19 more)

### Community 231 - "Community 231"
Cohesion: 0.09
Nodes (22): seqKey(), AddCreature(), AddCreatureProps, CreatureOption, nextMonsterOrdinal(), seatableCharacter(), { catalogue }, useBestiary() (+14 more)

### Community 232 - "Community 232"
Cohesion: 0.08
Nodes (25): STARTING_EQUIPMENT_BY_BG, BACKGROUNDS_BY_ID, buildBackgroundGrants(), findBackground(), getBackground(), getBackgroundEquipmentOptions(), getBackgroundFeatOptions(), getBackgroundOriginFeat() (+17 more)

### Community 233 - "Community 233"
Cohesion: 0.11
Nodes (21): getDB(), loadBreadcrumbs(), persistBreadcrumbs(), buildReport(), byteLength(), clock(), context, diagnosticsLog() (+13 more)
...
Cohesion: 0.09
Nodes (24): Effect, encounterRef(), personalEncounterRef(), subscribeEncounter(), characterRef(), EncounterLease, joinTable(), leaveTable() (+16 more)
...
Cohesion: 0.08
Nodes (23): backgroundName(), ClassGalleryVM, className(), classStartingEquipment(), classTip(), CreationOptionVM, equipmentCategory(), featName() (+15 more)

### Community 264 - "Community 264"
Cohesion: 0.10
Nodes (23): ChronicleFeed(), EndEncounterDialog(), FeedLine(), MemberDetails, useChronicleResolvers(), ResolveAction, base, localize() (+15 more)

### Community 265 - "Community 265"
Cohesion: 0.14
Nodes (26): driveBoundary(), planWorldRest(), planAdversaryTurnBoundary(), planMechanicsWorldAction(), AudienceEntry, DriveContext, FrameRecord, frameRef() (+18 more)
...
Cohesion: 0.15
Nodes (24): recordDirectPcEffectEvents(), reduceDeclaredEffects(), appendEvent(), DistributiveOmit, mapEvent(), NewChronicleEvent, recordCondition(), recordMonsterDamage() (+16 more)
...
Cohesion: 0.10
Nodes (17): DraftPortrait, MonsterEntry, MonsterPortraitPanel, PortraitCropModal, customMonsterToInput(), toMonsterInput(), makeEncounterMonsterSpec(), MonsterInput (+9 more)
...
Cohesion: 0.12
Nodes (14): reduceCampaignCombatMutation(), storedCharacterLifecycleEligible(), clampTemp(), HpAfterDamage, CombatSessionHydrationResult, initiativeToNumber(), initiativeToString(), mergeCombatTrio() (+6 more)
...
Cohesion: 0.11
Nodes (21): kernelRequest(), ACTOR_DISADVANTAGE_CONDITIONS, CombatAttackContextEffect, CombatAttackContextFact, CombatAttackCover, CombatAttackModeAdjustment, CombatAttackRangeBand, CombatAttackTableFacts (+13 more)
...
Cohesion: 0.12
Nodes (20): materialRefKey(), ownerMaterialKey(), characterRefResolves(), sharedRefResolves(), appendDiff(), appendMutation(), factSortKey(), isJsonObject() (+12 more)
...
Cohesion: 0.13
Nodes (18): defineFilter(), charClassOf(), charLevelOf(), effectiveClass(), featureSpec, featureText(), CR_BANDS, monName() (+10 more)
...
Cohesion: 0.10
Nodes (10): attachEncounterEffects(), CharacterState, CombatHydrationPatch, D20CommandSnapshot, D20TestCommitResult, effectiveCombatEffects(), MechanicsPlanCommitResult, persistCombat() (+2 more)
...
Cohesion: 0.12
Nodes (13): i18nReady, IdentityApp(), IdentityBoundary, recoverFromChunkPreloadError(), installDomResilience(), NodeTreePrimitives, warned, warnOnce() (+5 more)

### Community 328 - "Community 328"
Cohesion: 0.16
Nodes (20): catalogueDefault(), counterFromCharges(), counterFromTracker(), createItemInstanceId(), isRecord(), isWhole(), ItemInstanceIdFactory, ItemResourceMigrationAmbiguity (+12 more)
...
Cohesion: 0.27
Nodes (7): historyObject(), HistoryRecord, NavigationController, parentRoute(), parseRoute(), routeHash(), safeId()
...
Cohesion: 0.26
Nodes (17): conformCommandIntent(), decodeCausalHead(), decodeCounterMap(), decodeCounterState(), decodeIntentInputs(), decodeItemResourceDisposition(), decodeItemResourceState(), decodeLastTransition() (+9 more)
...
Cohesion: 0.25
Nodes (16): applyResourceOperation(), commandOfIntent(), countersConformToItem(), deepEqual(), isCanonicalItemResourceIdentity(), isValidItemInstanceId(), isValidItemResourceId(), isValidItemResourceState() (+8 more)

### Community 402 - "Community 402"
Cohesion: 0.22
Nodes (15): collectTiles(), CORE_ICON, DAMAGE_ICON, damageOf(), economyOf(), GROUP_ICON, groupOf(), hotbarTiles() (+7 more)
...
Cohesion: 0.21
Nodes (14): deliverDamage(), applyConditionOverride(), applyOverride(), conditionEffectsOn(), ConditionPatch, CONDITIONS, isLifeState(), LIFE_STATES (+6 more)
...
Cohesion: 0.18
Nodes (10): EngineCommitMirror, registerEngineCommitUndo(), registerUndoable(), registerUndoableResult(), registerUndoableToast(), UndoApplier, UndoEntry, UndoLabel (+2 more)
...
Cohesion: 0.21
Nodes (11): adjustPacket(), applyDamage(), DamageOptions, DamagePacket, DamageResult, Payment, RiderAnswer, DamagePart (+3 more)
...
Cohesion: 0.20
Nodes (11): mergeStartingEquipment(), ALL_TOOL_CHOICE_KINDS, ARTISAN_TOOL_ID_SET, EMPTY_RESULT, expandToolChoiceItem(), getBackgroundStartingEquipment(), ResolvedStartingEquipment, resolveStartingEquipment() (+3 more)
...
Cohesion: 0.21
Nodes (8): AuthoringFamily, character, classBuild(), partial(), requiredRoleBackground(), selection(), snapshot(), verifyCatalogue()
...
Cohesion: 0.44
Nodes (9): commitBoundary(), commitPartyAttackParticipation(), endLocalEncounter(), firePassedTurnBoundaries(), observePartyWorldFights(), OpenCharacterWorld, PartyFightSnapshot, reconcileLease() (+1 more)
...
Cohesion: 0.27
Nodes (7): devCharacterDocumentId(), DevCharacterParent, mergeDevCharacterParent(), readDevCharacter(), asSlot(), normalizeLogEntry(), sanitizeSession()
...
Cohesion: 0.22
Nodes (8): darts, name, martial-weapons, martial-weapons-finesse-or-light, name, name, shortbows, name
...
Cohesion: 0.22
Nodes (8): celestial, name, gnoll, name, gnomish, name, goblin, name
...
Cohesion: 0.36
Nodes (6): resolveDevDoc(), DEV_FIXTURE_NAMES, fixtureName(), isDevFixtureId(), loadDevFixture(), isDevScenarioRouteId()
...
Cohesion: 0.29
Nodes (6): buildGrantedFeatures(), deriveOriginFeats(), GrantedFeatureInput, syncOriginFeats(), inferFeaturesForEntry(), incompleteFreeCastChoiceFeatIds()
...
Cohesion: 0.36
Nodes (6): characterSpellCapability(), commit(), docWithEngineBlur(), drive(), liveWorld(), wizardDoc()

### Community 650 - "Community 650"
Cohesion: 0.36
Nodes (6): MapTool, RAIL, RailItem, ToolRail(), ToolRailProps, PlayTool
...
Cohesion: 0.38
Nodes (5): eligibleManeuvers(), listManeuvers(), maneuversKnownAt(), newManeuversAtLevel(), maneuverOptions()
...
Cohesion: 0.33
Nodes (4): FIGHTING_STYLE_PLACEHOLDERS, listAllFightingStyles(), listFightingStyles(), fightingStyleOptions()
...
Cohesion: 0.40
Nodes (4): listMetamagicOptions(), metamagicKnownAt(), metamagicPicksAtLevel(), metamagicOptions()
...
Cohesion: 0.67
Nodes (3): LoadState, SharedCharacterView(), useNoIndex()
...
## Knowledge Gaps
- **18815 isolated node(s):** `npx`, `schema_version`, `diagram_type`, `title`, `quality_profile` (+18810 more)
...
- **Why does `localizeSrd()` connect `Community 110` to `Community 1025`, `Community 6`, `Community 263`, `Community 521`, `Community 9`, `Community 15`, `Community 143`, `Community 280`, `Community 32`, `Community 1065`, `Community 172`, `Community 46`, `Community 49`, `Community 55`, `Community 183`, `Community 317`, `Community 66`, `Community 197`, `Community 202`, `Community 79`, `Community 213`, `Community 361`, `Community 2545`, `Community 119`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `srdCatalogues()` connect `Community 15` to `Community 566`, `Community 314`, `Community 157`, `Community 110`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `mergedUi()` connect `Community 87` to `Community 592`, `Community 126`, `Community 301`, `Community 686`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **What connects `npx`, `schema_version`, `diagram_type` to the rest of the system?**
  _18815 weakly-connected nodes found - possible documentation gaps or missing edges._
