...
## Summary
- 31693 nodes · 42410 edges · 3218 communities (2633 shown, 585 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 3342 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7e6a712b`
...
- `Probe()` --calls--> `useTurnEconomy()`  [INFERRED]
  tests/unit/item-resource-alternate-payment.test.tsx → src/features/character/center/useTurnEconomy.ts
...
## Communities (3218 total, 585 thin omitted)
...
Cohesion: 0.01
Nodes (146): AdminPage(), AdminSheet(), AdminSheetView(), LibraryMount(), SettingsPage(), useLoadExample(), AppShell(), CampaignArtControl() (+138 more)
...
Cohesion: 0.02
Nodes (200): characterWorldValue(), clampedExhaustion(), omitKeys(), recoveredCharacterState(), recoveredTrackerUsed(), REST_SECONDS, restFinalizedSession(), RestWorldEntries (+192 more)
...
Cohesion: 0.03
Nodes (167): derivePartyMemberStats(), CombatHeader(), CombatResolver(), RestFlow(), buildCatalogue(), ABILITIES, dumpSheet(), LeftHud() (+159 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (142): label(), classFeatureIndex, classFeatures, classTableIndex, classTables, getClassFeatures(), getClassTable(), getFeaturesAtLevel() (+134 more)
...
Cohesion: 0.04
Nodes (98): advancedCollections(), composeOriginBuild(), srdCatalogues(), useAcquisitionLabels(), AdvancedFields(), AdvancedReader(), Bestiary(), archiveKeys() (+90 more)
...
Cohesion: 0.04
Nodes (93): RetainedCreation, StoragePort, ImportDraft, parseImportDraft(), createImportRepository(), exactReceipt(), ImportOperation, ImportReceipt (+85 more)
...
Cohesion: 0.03
Nodes (65): DraftPortrait, MonsterEntry, MonsterPortraitPanel, PortraitCropModal, customMonsterToInput(), toMonsterInput(), makeEncounterMonsterSpec(), MonsterInput (+57 more)

### Community 34 - "Community 34"
Cohesion: 0.07
Nodes (95): refreshMechanicsProgramProjectedCompilationContext(), conformEntityRef(), acceptMechanicsPendingFramePhaseTransition(), advanceMechanicsPendingFrameSlot(), advanceMechanicsPendingFrameStep(), betweenTurnsEconomy(), boundaryOwnedFactsMatch(), causeKey() (+87 more)

### Community 35 - "Community 35"
Cohesion: 0.03
Nodes (70): MovementSlider(), MovementSliderProps, snapClamp(), EconFilterType, ThisTurnTracker(), advanceSharedTurn(), combatantUid(), observedOwnerBoundary() (+62 more)

### Community 36 - "Community 36"
Cohesion: 0.03
Nodes (49): resolveActiveSpeedRiderBonus(), mageDoc(), monkAtLevel(), fixture(), planned(), clericDoc(), healerDoc(), marcoDoc() (+41 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (83): storedCharacterConcentration(), EN_TO_TOKEN, enToProficiencyToken(), KNOWN_TOKENS, ABILITY_CODES, ARMOR_CATEGORIES, ArmorCategory, asString() (+75 more)

### Community 38 - "Community 38"
Cohesion: 0.05
Nodes (91): advanceEncounterTurn(), appendChronicleChapter(), appendCombatEffectOp(), appendPersistentCombatEffect(), appendPersistentCombatEffectOp(), appendPersistentCombatEffectOpOptimistic(), applyDeclaredCombatEffects(), applyDeclaredEffectsOptimistic() (+83 more)

### Community 39 - "Community 39"
Cohesion: 0.02
Nodes (77): CONDITION_ICONS, StatusLedge(), applyActionConcentration(), confirmConcentrationSwap(), localizeCustom(), customConcentrationValue(), auraEffectLine(), ChoiceResistancePicker() (+69 more)
...
Cohesion: 0.05
Nodes (82): ActionProgram, AdvancedCollection, advancedFields(), AdvancedResource, advancedRowFields(), AdvancedRowKind, b(), blankAdvancedRow() (+74 more)
...
Cohesion: 0.03
Nodes (70): potentialPcDamageTargetIds(), getSpellById(), spellIndex, spells, buildCastOptions(), CastLevelOption, CastRecoveryCadence, classifySpellCastingTime() (+62 more)

### Community 52 - "Community 52"
Cohesion: 0.04
Nodes (52): fmtMod(), HoverTip(), PlayRefDeepLink(), TAB_DEFS, TabDef, TabBody(), TabsProvider(), TabStrip() (+44 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (64): EntryViewProps, CmpSeal(), CompendiumDetailBody(), CompendiumVerdict, defineFilter(), FilterGroup, Locale, PickerCtx (+56 more)
...
Cohesion: 0.04
Nodes (81): projectCreatureConditions(), creatureVitalsFor(), directConditionInstances(), documentFor(), projectEntityConditions(), projectResolvedEntityConditions(), resolvedEntityConditions(), blueprintEntityKey() (+73 more)
...
Cohesion: 0.07
Nodes (82): materialRefKey(), ABILITY_CODES, allOccurrenceRefsResolve(), ARMOR_CATEGORIES, CharacterMaterialRef, characterRefResolves(), conformInventoryInstance(), conformMaterialEntity() (+74 more)

### Community 58 - "Community 58"
Cohesion: 0.06
Nodes (78): authenticReviewedIntents, bindingsFor(), canonicalResourceCandidates(), characterMaterialRef(), comparison(), compilationPredicateContext(), conformAnswersStructure, conformIntentStructure (+70 more)
...
Cohesion: 0.05
Nodes (66): MobileDisclosure(), cn(), WhyProse(), Badge(), BadgeProps, BadgeSize, BadgeVariant, VARIANT_CLASS (+58 more)
...
Cohesion: 0.07
Nodes (65): budget(), CreationCandidate, CreationReceipt, CreationRepository, CreationValidation, creationCandidate(), creationCatalogue(), creationWithOwnedEquipment() (+57 more)
...
Cohesion: 0.04
Nodes (43): InitVital(), MonsterInitChip(), InputAnswer, ItemResourceCommandProvider(), PendingInput, CommittedItemResourceBoundary, CommittedItemResourceCommand, createItemResourcePaymentCycle() (+35 more)

### Community 74 - "Community 74"
Cohesion: 0.06
Nodes (56): fail(), keys(), parseAcquisitionSelection(), record(), safeInt(), createClassBuildReader(), AuthoringFamily, initializeDefinition() (+48 more)
...
Cohesion: 0.05
Nodes (66): loadSharedCharacter(), LoadState, SharedCharacterView(), useNoIndex(), onErrorReport(), setDiagnosticsContext(), collection(), AdminCampaignSummary (+58 more)
...
Cohesion: 0.08
Nodes (69): actionBody(), actionFits(), actionJournalByteLength(), actionJournalCanonicalJson(), actualAtPath(), applyTransition(), boundedCommittedActions(), compareByKey() (+61 more)

### Community 79 - "Community 79"
Cohesion: 0.07
Nodes (68): reviewedPaymentsAreAffordable(), applyResourceOperation(), characterParts(), commandOfIntent(), conformCommandIntent(), conformInitializationObservationsStructure, conformResourceOperation(), conformResourceOperationStructure (+60 more)

### Community 80 - "Community 80"
Cohesion: 0.04
Nodes (28): customInstanceId(), ringOfProtection(), SCORES, portraitToDataUrl, concentrationWorld(), rawWorld(), vitalsDoc(), BARBARIAN (+20 more)

### Community 81 - "Community 81"
Cohesion: 0.06
Nodes (56): AbilityIssue, checkCreationAbilities(), CreationMethod, CreationScores, POINT_COST, STANDARD_SCORES, active(), creationCandidate() (+48 more)
...
Cohesion: 0.04
Nodes (30): HERE, I18N_ROOT, Json, mergedUi(), consult(), codes, en, ENGINE_FILES (+22 more)
...
Cohesion: 0.05
Nodes (48): createTurnEconomyState(), alive(), appendZeroedRoot(), AUTHORITIES_BY_CAUSE, authoritySnapshotFor(), CAPABILITY, causalState(), CHARACTER (+40 more)

### Community 88 - "Community 88"
Cohesion: 0.04
Nodes (38): abilityMod(), buildDevRosterDocs(), buildDevScenario(), buildScenario(), DEV_SCENARIOS, devPortrait(), PUBLIC_SCENARIOS, resolveScenarioToolKit() (+30 more)

### Community 89 - "Community 89"
Cohesion: 0.06
Nodes (53): driveBoundary(), planWorldRest(), planAdversaryTurnBoundary(), createEmptyCharacterMaterialState(), planMechanicsWorldAction(), advanceMechanicsBoundary(), beginMechanicsBoundary(), beginMechanicsCausalState() (+45 more)
...
Cohesion: 0.07
Nodes (51): HpVital(), MonsterHpStat(), ReadOnlyHpChip(), HeaderHpControl(), DamageReactionBanner(), DamageReactionPrompt(), DyingBanner(), bloodiedFromHp() (+43 more)

### Community 92 - "Community 92"
Cohesion: 0.08
Nodes (56): answerNumber(), answerPosition(), AreaResolution, areaShapeFrom(), adjustPacket(), applyDamage(), applyHealing(), DamageOptions (+48 more)

### Community 93 - "Community 93"
Cohesion: 0.06
Nodes (57): RollRecord, EndResult, FoldResult, ActionId, EffectId, EntityId, LabelId, WindowId (+49 more)

### Community 94 - "Community 94"
Cohesion: 0.06
Nodes (52): reverseEngineAction(), conformMechanicsProgramAuthorityReceipt(), conformMechanicsProgramAuthorityReceiptStructure, EntityInstallationOwner, InstallationOwner, isEntityActor(), mechanicsProgramAuthorityReceiptFingerprint(), MechanicsProgramAuthorityReceiptSchemaRefTypes (+44 more)

### Community 95 - "Community 95"
Cohesion: 0.05
Nodes (43): LevelUpWizard(), FIGHTING_STYLE_PLACEHOLDERS, listAllFightingStyles(), listFightingStyles(), eligibleInvocations(), invocationsKnownAt(), knownInvocationIds(), listInvocations() (+35 more)
...
Cohesion: 0.05
Nodes (47): applyExpertisePicks(), EXPERTISE_FEATURE_IDS, listExpertiseEligibleSkills(), arePicksComplete(), applyExpertiseChoicePicks(), ExpertiseChoicePicks, ExpertiseChoiceSlot, isExpertisePicksComplete() (+39 more)

### Community 99 - "Community 99"
Cohesion: 0.05
Nodes (49): CreationWizard(), mergeStartingEquipment(), getBackgroundEquipmentOptions(), ALL_TOOL_CHOICE_KINDS, ARTISAN_TOOL_ID_SET, EMPTY_RESULT, expandToolChoiceItem(), getBackgroundStartingEquipment() (+41 more)
...
Cohesion: 0.09
Nodes (48): BundledSnapshot, baseFields(), decodePortable(), encodePortable(), exact(), object(), parseVersion(), PortableResult (+40 more)
...
Cohesion: 0.07
Nodes (49): dueAt(), endEffects(), cellUnderFog(), DropPlan, hideRect(), isCoord(), isMapBackground(), isMapGrid() (+41 more)
...
Cohesion: 0.08
Nodes (35): validResourceId(), defaultPreparedState(), integer(), keys(), materializePreparedCopy(), parsePreparationVersion(), parsePreparedCopy(), parsePreparedState() (+27 more)
...
Cohesion: 0.06
Nodes (35): INITIAL, asLocale(), Locale, LOCALES, FeatAbilityPick, FeatAbilityPicker(), Props, BgAsiPicker() (+27 more)
...
Cohesion: 0.07
Nodes (43): Catalogue, CatalogueError, mechanicOf(), programOf(), conformMechanicShape, parseMechanicValue(), coverageFor(), CoverageRow (+35 more)

### Community 119 - "Community 119"
Cohesion: 0.06
Nodes (43): hasSrd(), localizeSrd(), DivineInterventionModal(), DivineInterventionModalProps, poolCopy(), monsterProse(), descriptionSearch(), assertResolves() (+35 more)
...
Cohesion: 0.07
Nodes (45): acyclic(), canonicalClone(), canonicalKey(), canonicalOccurrence(), conformEndRule(), conformEndRuleStructure, conformIntegerAtLeast(), conformNewMechanicOccurrence() (+37 more)
...
Cohesion: 0.07
Nodes (42): bootstrap(), changeLanguage(), ensureLocale(), ensureSrdKind(), inflight, inflightKind, uiLoaded, JsonModule (+34 more)
...
Cohesion: 0.04
Nodes (45): dragonborn.traits.breath-weapon.mechanics.actions.0, description, dragonborn.traits.draconic-ancestry.grants.0, label, dragonborn.traits.draconic-ancestry.grants.0.options.brass, label, dragonborn.traits.draconic-ancestry.grants.0.options.bronze, label (+37 more)
...
Cohesion: 0.12
Nodes (45): allocateTimelineBoundary(), beginMechanicsBoundaryFromCausalState(), beginMechanicsBoundaryFromState(), boundaryRejected(), cleanEndedMaterial(), clockResolves(), continueCompleteTurn(), currentRemovalAuthorized() (+37 more)
...
Cohesion: 0.10
Nodes (38): commitBoundary(), commitPartyAttackParticipation(), endLocalEncounter(), firePassedTurnBoundaries(), observePartyWorldFights(), OpenCharacterWorld, PartyFightSnapshot, reconcileLease() (+30 more)
...
Cohesion: 0.08
Nodes (24): BrowserProps, CompendiumBrowser(), EntryView(), CompendiumFacets(), FacetsProps, useActiveTabScroll(), ScrollMemory, ScrollMemoryStore (+16 more)

### Community 149 - "Community 149"
Cohesion: 0.06
Nodes (38): ABILITY_CODES, fmt(), setToArr(), SheetDump, spellName(), localeRangePair(), buildFeatureVMs(), CharacterIdentityLine() (+30 more)
...
Cohesion: 0.08
Nodes (32): castingTimeI18nKey(), CASTING_TIMES, castingTimeOption(), CustomSpellEditForm(), engineSpellCastRequest, EngineSpellGateInput, buildFacts(), buildGloss() (+24 more)
...
Cohesion: 0.10
Nodes (36): ABILITIES, automaticOutcome(), boundedUniqueSources(), conformD20TestObservation(), conformD20TestRequest(), conformObservationStructure, conformRequestStructure, D20_SCHEMA_CONTEXT (+28 more)

### Community 156 - "Community 156"
Cohesion: 0.10
Nodes (38): replacementTrailsAreAuthorized(), acceptedTrailFace(), addBounds(), aggregateId(), conformAcceptancePolicyStructure, conformDiceAcceptancePolicy(), conformDiceFormula(), conformDiceObservation() (+30 more)
...
Cohesion: 0.08
Nodes (32): conformCounter(), conformHomebrewDefinitionOwnerRef(), conformHomebrewDefinitionOwnerRefStructure, conformMechanicsCapabilityInstallationRef(), conformMechanicsCapabilityInstallationRefStructure, conformMechanicsCapabilityRef(), conformMechanicsCapabilityRefStructure, conformMechanicsDefinitionRef() (+24 more)
...
Cohesion: 0.10
Nodes (28): checkpointThrough(), compact(), ENCODER, encounterBytes(), pruneRolls(), shouldCompact(), throughNow(), EncounterParse (+20 more)
...
Cohesion: 0.09
Nodes (28): reduceDeclaredEffects(), EncounterPcSeed, encounterRollFor(), finiteNumber(), hasOnlyKeys(), isEncounterMonster(), isEncounterPc(), isPortraitCrop() (+20 more)
...
Cohesion: 0.08
Nodes (33): reduceDirectPcEffects(), Lifetime, ActiveIncomingAttackModeAdjustment, ActiveRollDieAdjustment, activeRollDieAdjustments(), ActiveRollModeAdjustment, activeRollModeAdjustments(), combatantStackingKey() (+25 more)

### Community 171 - "Community 171"
Cohesion: 0.06
Nodes (34): hasActiveSpendOwner(), ConcentrationSavePrompt(), attunementSatisfied(), EquipRef, requiresAttunement(), CharacterConcentrationSaveD20Context, CharacterD20ContextBase, CharacterD20ModifierTerm (+26 more)

### Community 172 - "Community 172"
Cohesion: 0.09
Nodes (32): conformMechanicsAuthorityDefinition(), conformMechanicsAuthorityDefinitionStructure, conformMechanicsAuthoritySnapshot(), conformMechanicsAuthoritySnapshotStructure, definitionClosureSemantics(), definitionSemantics(), factGuardKey(), guardsAreCanonical() (+24 more)
...
Cohesion: 0.07
Nodes (29): alive(), AUTHORITIES_BY_CAUSE, authoritySnapshotFor(), CAPABILITY, causalState(), context(), createFrame(), damageOperation() (+21 more)

### Community 183 - "Community 183"
Cohesion: 0.08
Nodes (26): subscribeToSharedCampaigns(), DEV_PIP_EPOCHS, DEV_PIP_INIT_TABLES, devEmpty(), devEncounterInitSeed(), devPcEntry(), devPipMode, devPipScenario (+18 more)

### Community 184 - "Community 184"
Cohesion: 0.08
Nodes (32): firstOf(), subscribeEncounter(), record(), authorsOf(), { catalogue }, Client, clientFor(), compactAndVerify() (+24 more)
...
Cohesion: 0.11
Nodes (34): matches(), AdversaryActionCapability, adversaryCapability(), adversaryConditionCapability(), adversaryDamageCapability(), adversaryEntity(), adversaryHealCapability(), adversaryTemplate() (+26 more)
...
Cohesion: 0.08
Nodes (33): BoundaryKind, exactBoundary(), factKey(), ItemResourceBoundaryFact, ItemResourceBoundaryInputRequest, ItemResourceBoundaryPreparation, ItemResourceBoundaryRejection, ItemResourceBoundaryReplayPreparation (+25 more)
...
Cohesion: 0.10
Nodes (26): EconomyPill(), EconomyPillProps, ROMAN, SIGNS, Hotbar(), HotbarProps, initials(), TAB_LABEL (+18 more)
...
Cohesion: 0.07
Nodes (23): expectLegalPreset(), listAvailableForLanguageSlot(), allowedSpellListsForSlot(), applySpellChoicePicks(), bestAbility(), isSpellChoicesComplete(), listAvailableForSlot(), pendingSpellChoicesForFeat() (+15 more)

### Community 205 - "Community 205"
Cohesion: 0.07
Nodes (22): applyCombatToRosterDoc(), buildCharacterCache(), cacheToRosterCharacter(), cacheToRosterDoc(), CharacterCache, readCache(), RosterCharacter, RosterCharacterDoc (+14 more)
...
Cohesion: 0.05
Nodes (18): readOpen(), SectionPanel(), CollapsibleSearch(), Props, CurrencyTokens(), CurrencyTokensProps, InfoCard(), InfoCardProps (+10 more)
...
Cohesion: 0.09
Nodes (23): seqKey(), AddCreature(), AddCreatureProps, CreatureOption, nextMonsterOrdinal(), seatableCharacter(), { catalogue }, useBestiary() (+15 more)
...
Cohesion: 0.08
Nodes (19): entryToCharacterItem(), AddItemModalProps, ItemTab, KINDS, CustomEquipmentForm(), CustomEquipmentFormProps, CustomFeatureForm(), CustomFeatureFormProps (+11 more)
...
Cohesion: 0.10
Nodes (23): AppliedQuickbuild, backgroundSkillIds(), canonical(), classSkillPool(), deal(), presetChoiceSlots(), quickbuildDraft, pick() (+15 more)
...
Cohesion: 0.08
Nodes (28): ADVANTAGE_MODES, AdvantageChip, ALL_SKILL_IDS, AttackRollView, effectiveLanguageTokens(), EffectiveProficiencyToken, effectiveTokens(), effectiveToolTokens() (+20 more)

### Community 243 - "Community 243"
Cohesion: 0.09
Nodes (18): addMonster(), beginEncounterTurns(), freezeOrder(), pcCombatant(), setHidden(), startEncounter(), toggleCondition(), addReinforcement() (+10 more)
...
Cohesion: 0.10
Nodes (26): genPlayable(), seqFactory(), { catalogue }, Fake, fakeTable(), fixtureLog(), mount(), RAPIER (+18 more)

### Community 246 - "Community 246"
Cohesion: 0.13
Nodes (22): CreationFlow(), ImportFlow(), AccountNavigation(), IdentityAccount(), IdentityNavigation(), NavigationContext, useIdentityNavigation(), IdentityWorkspaceProps (+14 more)

### Community 247 - "Community 247"
Cohesion: 0.13
Nodes (25): cellCenterPx(), cellsRect(), cellToPx(), DEFAULT_GRID, feetToMetres(), fitViewport(), Ground, groundOf() (+17 more)
...
Cohesion: 0.10
Nodes (16): reduceCampaignCombatMutation(), storedCharacterLifecycleEligible(), clampTemp(), HpAfterDamage, CombatSessionHydrationResult, initiativeToNumber(), initiativeToString(), mergeCombatTrio() (+8 more)
...
Cohesion: 0.07
Nodes (27): loadPackLazySrd(), loadPackSrdCatalogues(), packBackgroundEquipment, packBackgroundNames, packBackgroundsRaw, packBeasts, packClassFeatures, packClassNames (+19 more)

### Community 262 - "Community 262"
Cohesion: 0.08
Nodes (19): useBackWithFallback(), actionHasDamage(), actionHasHealing(), actionHasTempHp(), actionRiderConditions(), combatDamageParts(), CombatDamagePartSpec, CombatOutcome (+11 more)
...
Cohesion: 0.09
Nodes (19): InitiativeStrip(), InitiativeStripProps, StripCell, conditionName(), createPlayLabels(), monsterLabelId(), PlayLabelArgs, SRD_KINDS (+11 more)
...
Cohesion: 0.09
Nodes (17): actionAtCastLevel(), replaceBaseFormula(), ScalableCombatSummary, scaleCombatSummaryAtCastLevel(), avatarTint(), displayAc(), formatWeight(), idToHue() (+9 more)
...
Cohesion: 0.07
Nodes (26): ankylosaurus, name, attack.beak, name, attack.fist, name, attack.sting, name (+18 more)
...
Cohesion: 0.08
Nodes (25): port, emulators, auth, firestore, functions, hosting, singleProjectMode, storage (+17 more)
...
Cohesion: 0.11
Nodes (19): encounterRef(), personalEncounterRef(), characterRef(), EncounterLease, joinTable(), leaveTable(), PersonalWriteBack, combatStateWriteData() (+11 more)

### Community 298 - "Community 298"
Cohesion: 0.10
Nodes (20): commandFor(), GainInputs, hasCanonicalIdentity(), ItemResourceCommandPreparation, ItemResourceCommandRecipe, ItemResourceCommandRejection, PreparedItemResourceCommand, prepareItemResourceCommand() (+12 more)

### Community 299 - "Community 299"
Cohesion: 0.13
Nodes (25): isEffectOccurrence(), resolveOccurrenceAuthority(), activeInventorySourceKeys(), creaturePresent(), discoverCandidates(), effectTargetsHolder(), entityGenerationResolves(), entityPresent() (+17 more)

### Community 300 - "Community 300"
Cohesion: 0.17
Nodes (23): buildPublicCharacterProjection(), buildPublicCharacterProjectionFromStoredParent(), CACHE_KEYS, CharacterStatus, CLASS_KEYS, cloneCache(), copyStringArray(), finiteNonNegative() (+15 more)
...
Cohesion: 0.12
Nodes (23): trailIds(), actionInput(), AttackCastPlan, authorityDefinition(), authorityReceipt(), authoritySnapshot(), CASCADE_PROGRAM, causalState() (+15 more)
...
Cohesion: 0.17
Nodes (22): recordDirectPcEffectEvents(), appendEvent(), DistributiveOmit, mapEvent(), NewChronicleEvent, recordCondition(), recordMonsterDamage(), recordMonsterHp() (+14 more)
...
Cohesion: 0.15
Nodes (23): operationChainsAreValid(), simulateItemResourceOperations(), catalogueDefault(), counterFromCharges(), counterFromTracker(), createItemInstanceId(), isItemInstanceId(), isRecord() (+15 more)

### Community 311 - "Community 311"
Cohesion: 0.12
Nodes (16): pushMechanicsPendingFrame(), authorityDefinition(), authoritySnapshot(), EmittedMechanicsTriggerEvidence, FAMILIAR, FIXED_ONE, HERO, OTHER_ROOT (+8 more)
...
Cohesion: 0.13
Nodes (20): collectDebugContext(), DebugContext, g, parseIds(), readJson(), readLocale(), readTheme(), safeString() (+12 more)
...
Cohesion: 0.10
Nodes (14): deleteCampaign(), dmNotesCollection(), notesCollection(), subscribeToCampaignNotes(), deleteCampaignBanner(), fireSnap(), NoteWire, parseCampaignWire() (+6 more)
...
Cohesion: 0.12
Nodes (21): answerKeyFor(), isPerTargetAnswer(), riderAnswers(), answersOnly(), formulaOf(), freeRoll(), FreeRollContext, inputIsLive() (+13 more)
...
Cohesion: 0.14
Nodes (21): storedTargetCombatState(), conformActiveCombatEffects(), CombatStateParseResult, isPlainJson(), isRecord(), KNOWN_COMBAT_STATE_KEY_MAP, KNOWN_COMBAT_STATE_KEYS, parseAppliedEncounterEffects() (+13 more)
...
Cohesion: 0.11
Nodes (13): childDomainKey(), isCharacterDocValue(), parentDomainKey(), reconciledDomainEquals(), serializeCharacterEnvelope(), canonical(), canonicalJsonEquals(), CharacterSnapshotReconciler (+5 more)

### Community 331 - "Community 331"
Cohesion: 0.10
Nodes (10): mergeActiveCombatEffects(), attachEncounterEffects(), CharacterState, CombatHydrationPatch, D20CommandSnapshot, D20TestCommitResult, effectiveCombatEffects(), MechanicsPlanCommitResult (+2 more)
...
Cohesion: 0.18
Nodes (19): purgeBugReports(), compressImage(), deleteBugReportScreenshot(), deleteMonsterPortrait(), deletePortrait(), IMAGE_UPLOAD_META, portraitToDataUrl(), uploadAndAttachPortrait() (+11 more)
...
Cohesion: 0.16
Nodes (20): initiativeOrder(), readyForTurns(), PlayScreen(), collectTiles(), CORE_ICON, DAMAGE_ICON, damageOf(), economyOf() (+12 more)
...
Cohesion: 0.13
Nodes (15): useEdgeFade(), useOverflowFade(), useOverflowFadeY(), DialogClose(), DialogContent(), DialogContentProps, DialogSize, DialogTrigger() (+7 more)

### Community 364 - "Community 364"
Cohesion: 0.14
Nodes (14): AudienceEntry, DriveContext, FrameRecord, frameRef(), freezeDeep(), INPUT_KEYS, isExactInput(), rejectedResult() (+6 more)
...
Cohesion: 0.12
Nodes (18): ANCHORS, authorityDefinition(), CAPABILITY, CATALOGUE_DEFINITION, CHARACTER_BUILD_DEFINITION, ENTITY, ENTITY_DEFINITION, executableSnapshot() (+10 more)
...
Cohesion: 0.12
Nodes (15): BACKGROUND_NAMES, backgroundNameById(), CLASS_NAMES, classNameById(), NamedEntry, PUBLIC_BACKGROUND_NAMES, PUBLIC_CLASS_NAMES, PUBLIC_RACE_NAMES (+7 more)
...
Cohesion: 0.14
Nodes (14): adjustmentPhase(), characterDamageReactionOptions(), composeDamageEntryProgram(), DamageEntryCommit, DamageReactionOption, DamageReactionRunResult, EnteredDamagePart, MAX_HP_ADDRESS (+6 more)
...
Cohesion: 0.15
Nodes (12): BEASTS, BEAST_INDEX, BEASTS, beastsByMaxCR(), getBeast(), applyStartingForm(), POLYMORPH_SPELL_IDS, polymorphBuildPatch() (+4 more)

### Community 417 - "Community 417"
Cohesion: 0.27
Nodes (15): AdversaryActionProvenance, applyAdversaryCondition(), applyAdversaryDamage(), applyAdversaryHeal(), completedCommit(), correlatedActionId(), runCapability(), stepEncounterTurn() (+7 more)
...
Cohesion: 0.18
Nodes (14): armorSealIcon(), CATEGORY_ICON, EQUIPMENT_BY_ID, equipmentCategoryIcon(), equipmentSealIcon(), equipmentSealIconById(), GEAR_ICON, gearSealIcon() (+6 more)
...
Cohesion: 0.16
Nodes (12): buildBudgetView(), EncounterBudgetView, EncounterCombatantView, EncounterView, PcLive, budgetVerdict, EncounterDifficulty, encounterXpCost() (+4 more)

### Community 454 - "Community 454"
Cohesion: 0.20
Nodes (10): resolveDevDoc(), devCharacterDocumentId(), DevCharacterParent, mergeDevCharacterParent(), readDevCharacter(), DEV_FIXTURE_NAMES, fixtureName(), isDevFixtureId() (+2 more)
...
Cohesion: 0.18
Nodes (8): { catalogue }, clientFor(), memberAction(), openingLog(), openRecorders, Recorder, refFor(), sessionFor()
...
Cohesion: 0.23
Nodes (8): authoredAuthority(), castCommitted(), fight(), fixture(), observe(), openDoc(), openWorld(), passTurn()
...
Cohesion: 0.24
Nodes (9): BaseProps, InlineEditableProps, InlineNumber(), InlineSelect(), InlineText(), NumberProps, SelectOption, SelectProps (+1 more)
...
Cohesion: 0.27
Nodes (5): AuthenticatedIdentity(), IdentityWorkspace(), SharedAssignment(), Draft, useClassBuild()
...
Cohesion: 0.24
Nodes (9): selectCompanionVariant(), buildCompanionCardViews(), buildOne(), CompanionAttackView, CompanionCardView, CompanionVariantOption, Ns, Translate (+1 more)
...
Cohesion: 0.22
Nodes (8): blink-dog, name, gnoll, name, gnomish, name, goblin, name

### Community 626 - "Community 626"
Cohesion: 0.22
Nodes (8): javelins, name, martial-weapons, martial-weapons-finesse-or-light, name, name, shortbows, name
...
Cohesion: 0.25
Nodes (3): child(), markedDoc(), { parentSubscribe, combatSubscribe }
...
Cohesion: 0.29
Nodes (7): ConformedFeatures, conformRaceTraitKey(), conformRaceTraitSessionIds(), matchRaceTrait(), RaceTraitMatch, remapSessionTrackerIds(), TrackerState
...
Cohesion: 0.25
Nodes (7): BreakdownLine, BreakdownLineExtras, BreakdownNote, BreakdownPartExtras, BreakdownWhy, BreakdownWhyLine, RawBreakdownPart
...
Cohesion: 0.43
Nodes (6): advanceGlobalCombat(), pendingApplies(), reconcileCombatPublish(), syncPipToStatus(), advanceTurn(), deadMonsterIds()
...
Cohesion: 0.33
Nodes (4): emptySwapChoice(), isSwapIncomplete(), SpellSwapChoice, WizardSpellSwap()
...
Cohesion: 0.40
Nodes (4): slotUsageKey(), slotResources(), buildConversionCtx(), pactRestoreAmount()

### Community 887 - "Community 887"
Cohesion: 0.50
Nodes (4): applyCastSourceOverrides(), applyCastSourceOverridesToAction(), CastSourceProfile, resolveCastSourceOverridesForLevel()
...
Cohesion: 0.40
Nodes (5): selectEffectiveConditionImmunities(), selectItemActivations(), selectStandingFacts(), currentRootMaxHpDelta(), liveZeroHpFloorSource()
...
Cohesion: 0.50
Nodes (3): BreakdownTip(), BreakdownTipProps, RUBRIC_KEY
...
## Knowledge Gaps
- **19241 isolated node(s):** `npx`, `schema_version`, `diagram_type`, `title`, `quality_profile` (+19236 more)
...
- **Why does `localizeSrd()` connect `Community 119` to `Community 129`, `Community 3`, `Community 6`, `Community 9`, `Community 267`, `Community 15`, `Community 400`, `Community 531`, `Community 149`, `Community 153`, `Community 33`, `Community 35`, `Community 39`, `Community 171`, `Community 53`, `Community 54`, `Community 578`, `Community 206`, `Community 99`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `srdCatalogues()` connect `Community 15` to `Community 577`, `Community 329`, `Community 129`, `Community 119`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `characterWorldState()` connect `Community 142` to `Community 153`, `Community 10`, `Community 491`, `Community 364`, `Community 398`, `Community 886`, `Community 89`, `Community 94`, `Community 57`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **What connects `npx`, `schema_version`, `diagram_type` to the rest of the system?**
  _19241 weakly-connected nodes found - possible documentation gaps or missing edges._
