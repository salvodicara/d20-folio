...
## Summary
- 31688 nodes · 42407 edges · 3235 communities (2648 shown, 587 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 3342 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9df09323`
...
1. `combat` - 465 edges
2. `combat` - 465 edges
3. `campaignHub` - 216 edges
4. `campaignHub` - 216 edges
5. `identity` - 204 edges
6. `identity` - 204 edges
7. `diagnostics` - 163 edges
8. `diagnostics` - 163 edges
9. `sheetFacts` - 152 edges
10. `sheetFacts` - 152 edges

## Surprising Connections (you probably didn't know these)
- `srcFor()` --calls--> `raceTraitCatKey()`  [INFERRED]
  tests/unit/species-lineage-spells-extended.test.ts → src/data/races.ts
- `parseCampaignWire()` --calls--> `subscribeToCampaign()`  [INFERRED]
  tests/unit/campaign-io.test.ts → src/features/campaigns/campaign-io.ts
- `SelectProbe()` --calls--> `useTurnEconomy()`  [INFERRED]
  tests/unit/ammo-debit.test.tsx → src/features/character/center/useTurnEconomy.ts
- `Probe()` --calls--> `useTurnEconomy()`  [INFERRED]
  tests/unit/cast-transaction-correctness.test.tsx → src/features/character/center/useTurnEconomy.ts
- `ApplyProbe()` --calls--> `useTurnEconomy()`  [INFERRED]
  tests/unit/cunning-strike-debit.test.tsx → src/features/character/center/useTurnEconomy.ts
...
## Communities (3235 total, 587 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.00
Nodes (463): combat, aboveLevelWarning, action, actions, actionUsedToast, activeSpellUse, addDamagePart, allActions (+455 more)
...
Cohesion: 0.01
Nodes (330): aboleth, adult-black-dragon, adult-blue-dragon, adult-brass-dragon, adult-bronze-dragon, adult-copper-dragon, adult-gold-dragon, adult-green-dragon (+322 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (166): AdminPage(), AdminSheet(), AdminSheetView(), LibraryMount(), SettingsPage(), useLoadExample(), AppShell(), CampaignArtControl() (+158 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (206): characterWorldValue(), clampedExhaustion(), omitKeys(), recoveredCharacterState(), recoveredTrackerUsed(), REST_SECONDS, restFinalizedSession(), RestWorldEntries (+198 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (215): campaignHub, access, addCoins, addNote, allNotes, amount, attachAlreadyElsewhere, attachCharacter (+207 more)
...
Cohesion: 0.02
Nodes (159): ABILITIES, dumpSheet(), abilityModifier(), computeCharacterMaxHp(), computeCharacterMaxHpBreakdown(), hpPerLevelGrantParts(), concentrationSaveD20Context(), projectCharacter() (+151 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (143): label(), getBackgroundOriginFeat(), classFeatureIndex, classFeatures, classTableIndex, classTables, getClassFeatures(), getClassTable() (+135 more)
...
Cohesion: 0.02
Nodes (136): raceTraitCatKey(), fmt(), hasSrd(), IS_PROD, localizeCustom(), localizeSrd(), localizeSrdList(), missing() (+128 more)
...
Cohesion: 0.02
Nodes (122): PcCombatantCard(), derivePartyMemberStats(), derivePcLive(), hydrateMemberDoc(), PartyMemberSave, PartyMemberStats, RestFlow(), acFromAggregate() (+114 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (100): advancedCollections(), composeOriginBuild(), srdCatalogues(), useAcquisitionLabels(), AdvancedFields(), AdvancedReader(), Bestiary(), archiveKeys() (+92 more)
...
Cohesion: 0.03
Nodes (97): RetainedCreation, StoragePort, ImportDraft, parseImportDraft(), createImportRepository(), exactReceipt(), ImportOperation, ImportReceipt (+89 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (109): ActionProgram, AdvancedCollection, advancedFields(), AdvancedResource, advancedRowFields(), AdvancedRowKind, b(), blankAdvancedRow() (+101 more)
...
Cohesion: 0.03
Nodes (56): resolveActiveSpeedRiderBonus(), mageDoc(), monkAtLevel(), capturePrepared(), chooseSubtleFireBolt(), Probe(), sorcerer(), spellAction() (+48 more)
...
Cohesion: 0.05
Nodes (84): AbilityIssue, checkCreationAbilities(), CreationMethod, CreationScores, POINT_COST, STANDARD_SCORES, active(), creationCandidate() (+76 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (74): HpVital(), MonsterHpStat(), ReadOnlyHpChip(), PlayRefDeepLink(), TAB_DEFS, TabDef, TabBody(), TabsProvider() (+66 more)
...
Cohesion: 0.02
Nodes (96): fix, ability-context, ability-maximum, ambiguous-feat-prerequisite, ambiguous-initial-spell, background-distribution, background-feat-required, background-tool-required (+88 more)
...
Cohesion: 0.06
Nodes (90): isEffectOccurrence(), resolveOccurrenceAuthority(), activeInventorySourceKeys(), allocateTimelineBoundary(), beginMechanicsBoundaryFromCausalState(), beginMechanicsBoundaryFromState(), betweenTurnsEconomy(), boundaryOwnedFactsMatch() (+82 more)

### Community 45 - "Community 45"
Cohesion: 0.03
Nodes (78): CreationWizard(), applyExpertisePicks(), arePicksComplete(), applyExpertiseChoicePicks(), ExpertiseChoicePicks, ExpertiseChoiceSlot, isExpertisePicksComplete(), pendingExpertiseSlotsForFeat() (+70 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (86): projectCreatureConditions(), creatureVitalsFor(), directConditionInstances(), documentFor(), projectEntityConditions(), projectResolvedEntityConditions(), resolvedEntityConditions(), selectEffectiveConditionImmunities() (+78 more)
...
Cohesion: 0.05
Nodes (86): advanceEncounterTurn(), appendChronicleChapter(), appendCombatEffectOp(), appendPersistentCombatEffect(), appendPersistentCombatEffectOp(), appendPersistentCombatEffectOpOptimistic(), applyDeclaredCombatEffects(), applyPersistentCombatEffectOperation() (+78 more)
...
Cohesion: 0.06
Nodes (79): BundledSnapshot, validResourceId(), conformOriginDefinition(), decodePortable(), encodePortable(), exact(), object(), parseVersion() (+71 more)
...
Cohesion: 0.04
Nodes (65): MovementSlider(), MovementSliderProps, snapClamp(), CONDITION_ICONS, StatusLedge(), EconFilterType, ThisTurnTracker(), advanceSharedTurn() (+57 more)

### Community 55 - "Community 55"
Cohesion: 0.06
Nodes (78): commitPartyAttackParticipation(), advanceSoloWorldTurn(), endSoloWorldEncounter(), enteredInitiativeRoll(), soloWorldFor(), reverseEngineAction(), planWorldRest(), restThroughWorld() (+70 more)
...
Cohesion: 0.03
Nodes (54): fmtMod(), InputAnswer, ItemResourceCommandProvider(), PendingInput, CommittedItemResourceBoundary, CommittedItemResourceCommand, createItemResourcePaymentCycle(), ItemResourceCommandApi (+46 more)

### Community 58 - "Community 58"
Cohesion: 0.07
Nodes (83): materialRefKey(), ownerMaterialKey(), ABILITY_CODES, allOccurrenceRefsResolve(), ARMOR_CATEGORIES, CharacterMaterialRef, characterRefResolves(), conformInventoryInstance() (+75 more)

### Community 59 - "Community 59"
Cohesion: 0.06
Nodes (79): authenticReviewedIntents, bindingsFor(), canonicalResourceCandidates(), characterMaterialRef(), comparison(), compilationPredicateContext(), conformAnswersStructure, conformIntentStructure (+71 more)

### Community 60 - "Community 60"
Cohesion: 0.04
Nodes (66): createEmptyCharacterMaterialState(), isMechanicsWorld(), parseMechanicsWorld(), validateClosedTurnState(), CHARACTER, count(), SELF, state() (+58 more)
...
Cohesion: 0.03
Nodes (73): AcFormula, ActivatableGroup, AdvantageClause, AggregatedGrants, ATTACK_CLAUSE_SCOPES, AttackClauseScope, AtWillCastEntry, AURA_AFFECTS (+65 more)
...
Cohesion: 0.07
Nodes (65): parseCreationDraft(), budget(), createCreationRepository(), CreationOperation, CreationReceipt, CreationRepository, CreationValidation, receipt() (+57 more)
...
Cohesion: 0.05
Nodes (52): pipScenarioCampaign(), asRaceId(), asAlignmentId(), assertNonEmptyString(), nonEmptyString, mkDruid(), mk(), mk() (+44 more)

### Community 72 - "Community 72"
Cohesion: 0.08
Nodes (67): SHEET_FONT_BYTES, BAND, BORDER, bubble(), caption(), captionCenter(), chip(), clip() (+59 more)
...
Cohesion: 0.09
Nodes (75): conformEntityRef(), acceptMechanicsPendingFramePhaseTransition(), advanceMechanicsPendingFrameSlot(), advanceMechanicsPendingFrameStep(), causeKey(), checkpointStateValid(), completionStateValid(), completionWorld() (+67 more)
...
Cohesion: 0.04
Nodes (35): loadPackSrdCatalogues(), HERE, I18N_ROOT, Json, mergedUi(), loadSrdCatalogues(), registerSrdCatalogues(), consult() (+27 more)

### Community 79 - "Community 79"
Cohesion: 0.08
Nodes (68): actionBody(), actionFits(), actionJournalByteLength(), actionJournalCanonicalJson(), actualAtPath(), applyTransition(), boundedCommittedActions(), compareByKey() (+60 more)

### Community 80 - "Community 80"
Cohesion: 0.04
Nodes (51): customMonsterToInput(), PcReadyCard(), useCombatWrite(), saves(), actionAtCastLevel(), replaceBaseFormula(), ScalableCombatSummary, scaleCombatSummaryAtCastLevel() (+43 more)
...
Cohesion: 0.04
Nodes (29): conc(), ALL_DOCS, canonical(), CROP, lift(), concentratingCharacter(), bardWithFont(), REST_BLOCK_CASES (+21 more)

### Community 84 - "Community 84"
Cohesion: 0.06
Nodes (58): auditCombatState(), auditDocument(), auditEnvelope(), auditLibrary(), auditPortableExport(), AuditVerdict, classify(), classifyPath() (+50 more)

### Community 85 - "Community 85"
Cohesion: 0.05
Nodes (23): customInstanceId(), ringOfProtection(), SCORES, portraitToDataUrl, concentrationWorld(), rawWorld(), vitalsDoc(), BARBARIAN (+15 more)

### Community 86 - "Community 86"
Cohesion: 0.05
Nodes (46): alive(), appendZeroedRoot(), AUTHORITIES_BY_CAUSE, authoritySnapshotFor(), CAPABILITY, causalState(), CHARACTER, concentratingWorld() (+38 more)

### Community 87 - "Community 87"
Cohesion: 0.04
Nodes (46): MobileDisclosure(), cn(), BreakdownTip(), BreakdownTipProps, RUBRIC_KEY, WhyProse(), ChoicePickerCard(), ChoicePickerCardProps (+38 more)

### Community 88 - "Community 88"
Cohesion: 0.05
Nodes (58): actionFactKey(), CAUSE_CONTEXT, causeAuthorizedByPendingTop(), conformCauseStructure, conformMaterialRef, conformMechanicsOperation(), conformMechanicsOperationCause(), conformMechanicsTransaction() (+50 more)

### Community 89 - "Community 89"
Cohesion: 0.06
Nodes (58): acyclic(), addOccurrence(), addTransitionedProgramOccurrence(), canonicalClone(), canonicalKey(), canonicalOccurrence(), canonicalState(), conformEndRule() (+50 more)

### Community 90 - "Community 90"
Cohesion: 0.03
Nodes (60): term, abilityScores, alignment, armorClass, attackRoll, attunement, background, bardicInspirationDie (+52 more)
...
Cohesion: 0.07
Nodes (33): crawl(), HERE, isUnder(), readSrc(), SRC_ROOT, srcFileMap(), srcFiles(), SrcFilesOptions (+25 more)
...
Cohesion: 0.05
Nodes (47): enToProficiencyToken(), ABILITY_CODES, ARMOR_CATEGORIES, ArmorCategory, asString(), BUILD_PASSTHROUGH, buildToMin(), CharacterEnvelope (+39 more)

### Community 95 - "Community 95"
Cohesion: 0.04
Nodes (55): combatChronicle, attributeLabel, attributeSkip, bardicInspirationGrant, conditionGain, conditionGainBy, conditionGainByAction, conditionLoss (+47 more)
...
Cohesion: 0.07
Nodes (44): description, name, I18N_ROOT, mergedUi(), PACK_I18N_ROOT, readShard(), shardNames(), srdCatalogue() (+36 more)
...
Cohesion: 0.06
Nodes (48): findBackground(), getBackgroundFeatOptions(), getFeaturesAtLevel(), backgroundIdByName(), buildCastOptions(), resolveScopedSlotLevel(), CreationChoiceInput, creationChoiceSlots() (+40 more)

### Community 101 - "Community 101"
Cohesion: 0.06
Nodes (51): collection(), AdminCampaignSummary, DEV_CHARACTER_COUNTS, DEV_USER_CHARACTERS, DevAdminUser, DevBugReport, devBugReports(), devCampaignSummaries() (+43 more)
...
Cohesion: 0.07
Nodes (38): checkpointThrough(), compact(), ENCODER, encounterBytes(), pruneRolls(), shouldCompact(), throughNow(), EncounterParse (+30 more)

### Community 109 - "Community 109"
Cohesion: 0.06
Nodes (17): actionText(), srd(), srdBi(), berserkerAt(), frenzyDice(), options, evalWith(), CASES (+9 more)
...
Cohesion: 0.08
Nodes (46): conformMechanicsProgram(), conformProgramStructure, allOf(), attackInput(), attackLanded(), attackOutcomeSelector(), CANONICAL_ROLL_RULES, cantripScaledCount() (+38 more)
...
Cohesion: 0.06
Nodes (44): applyDeclaredEffectsOptimistic(), campaignMemberHpMax(), conditionEffectIdsRemovedBy(), memberCombatMax(), pcCombatantRef(), reduceDirectPcEffects(), reducePersistentMonsterDamage(), monsterDamageDefenses() (+36 more)
...
Cohesion: 0.11
Nodes (43): answerNumber(), answerPosition(), AreaResolution, areaShapeFrom(), adjustPacket(), applyDamage(), applyHealing(), DamageOptions (+35 more)

### Community 120 - "Community 120"
Cohesion: 0.07
Nodes (41): buildCatalogue(), Catalogue, CatalogueError, mechanicOf(), programOf(), conformMechanicShape, parseMechanicValue(), coverageFor() (+33 more)

### Community 121 - "Community 121"
Cohesion: 0.06
Nodes (31): LongPressHandlers, useLongPress(), UseLongPressOptions, useRealmBackdrop(), BulkStatusResult, setCharactersStatus(), CharacterCard(), CharacterCardProps (+23 more)
...
Cohesion: 0.04
Nodes (45): dragonborn.traits.breath-weapon.mechanics.actions.0, description, dragonborn.traits.draconic-ancestry.grants.0, label, dragonborn.traits.draconic-ancestry.grants.0.options.blue, label, dragonborn.traits.draconic-ancestry.grants.0.options.brass, label (+37 more)
...
Cohesion: 0.08
Nodes (35): reduceDeclaredEffects(), undoHpEvent(), advanceTurn(), applyHp(), deadMonsterIds(), EncounterPcSeed, encounterRollFor(), finiteNumber() (+27 more)

### Community 132 - "Community 132"
Cohesion: 0.07
Nodes (39): loadPackLazySrd(), bootstrap(), changeLanguage(), ensureLocale(), ensureSrdKind(), inflight, inflightKind, uiLoaded (+31 more)
...
Cohesion: 0.05
Nodes (42): identifier(), mechanicsProgramEffectOccurrenceId(), CHARACTER_MATERIAL_REF_SCHEMA, CharacterMaterialRefSchemaShape, CLOCK_REF_SCHEMA, ClockRefSchemaShape, conformClockRef(), conformClockRefStructure (+34 more)
...
Cohesion: 0.06
Nodes (27): entryToCharacterItem(), LIBRARY_KIND_LABEL_KEY, LIBRARY_KINDS, LibraryDraft, LibraryEntry, LibraryKind, SheetLibraryDraft, SheetLibraryEntry (+19 more)

### Community 142 - "Community 142"
Cohesion: 0.08
Nodes (39): ActionClaim, AttackActionClaim, AttackUse, attackUseInState(), BonusActionClaim, budgetFor(), claimBonusAction(), conformCommandStructure (+31 more)
...
Cohesion: 0.05
Nodes (40): ImportFlow(), firestore, rules, hosting, headers, ignore, public, rewrites (+32 more)

### Community 146 - "Community 146"
Cohesion: 0.10
Nodes (37): ABILITIES, automaticOutcome(), boundedUniqueSources(), conformD20TestObservation(), conformD20TestRequest(), conformObservationStructure, conformRequestStructure, D20_SCHEMA_CONTEXT (+29 more)
...
Cohesion: 0.10
Nodes (36): dueAt(), endEffects(), cellUnderFog(), DropPlan, hideRect(), isCoord(), isMapBackground(), isMapCell() (+28 more)
...
Cohesion: 0.08
Nodes (26): CONTENT_PACK_ENTRY, CONTENT_PACK_ITEM_ART_ENTRY, CONTENT_PACK_MONSTER_ART_ENTRY, CONTENT_PACK_MONSTERS_ENTRY, contentPackEnabled(), fsAllowRoots(), PACK_EMPTY_ENTRY, packAliasTarget() (+18 more)
...
Cohesion: 0.05
Nodes (38): (a) DM prep: encounter building, balancing (2024 XP budgets), reuse, checklists, (b) Initiative and turn order; player-facing order; "your turn" signalling, Baldur's Gate 3, Baldur's Gate 3, Baldur's Gate 3, Baldur's Gate 3, Baldur's Gate 3, (c) Combat resolution: attack/damage/save flows, receipts, undo, DM override, hidden rolls (+30 more)
...
Cohesion: 0.08
Nodes (30): castingTimeI18nKey(), CASTING_TIMES, castingTimeOption(), CustomSpellEditForm(), buildFacts(), buildGloss(), buildMaterialCostTag(), buildVerdict() (+22 more)
...
Cohesion: 0.11
Nodes (35): acceptedTrailFace(), addBounds(), aggregateId(), conformAcceptancePolicyStructure, conformDiceAcceptancePolicy(), conformDiceFormula(), conformDiceObservation(), conformDiceReplacementPolicy() (+27 more)

### Community 165 - "Community 165"
Cohesion: 0.10
Nodes (38): boundaryRulesUseCurrentAllocation(), concentrationsForTarget(), documentFor(), effectiveConditionImmunities(), entityExists(), entityGenerationExists(), exactKeys(), exhaustionFor() (+30 more)

### Community 166 - "Community 166"
Cohesion: 0.16
Nodes (36): executeOperation(), maximumRejection(), applyCreatureDamage(), applyDeathSaveOutcome(), applyObjectDamage(), canonicalAfter(), canonicalObjectAfter(), clearTemporaryHitPoints() (+28 more)

### Community 167 - "Community 167"
Cohesion: 0.09
Nodes (35): RollRecord, ActionId, EntityId, LabelId, WindowId, MapToken, monsterMechanics(), conditionImmunities() (+27 more)
...
Cohesion: 0.09
Nodes (24): rankedSearch(), excerptOf(), featPickCategories(), featPickVM, offeredFeatVMs(), originFeatVMs(), summaryOf(), MorphValue() (+16 more)

### Community 170 - "Community 170"
Cohesion: 0.09
Nodes (28): EconomyPill(), EconomyPillProps, ROMAN, SIGNS, Hotbar(), HotbarProps, initials(), TAB_LABEL (+20 more)
...
Cohesion: 0.06
Nodes (19): DESKTOP, DESKTOP_OVERLAY_VARIANTS, FULL_PAGE_VARIANTS, GUIDED_STEP_TARGETS, GuidedStepTarget, Locale, MOBILE, openFamiliarStatblock() (+11 more)

### Community 183 - "Community 183"
Cohesion: 0.11
Nodes (31): addressIsValid(), addressKey(), applyMechanicsPlanToCharacter(), commandIsValid(), ConversionCtx, ConversionOptionVM, conversionOptionVMs(), isRecord() (+23 more)

### Community 184 - "Community 184"
Cohesion: 0.12
Nodes (33): asString(), Coin, COIN_KEYS, COMBAT_STATE_KEY_SET, CompactPlayState, CompactSessionState, CompactTrackerState, expandUsed() (+25 more)

### Community 185 - "Community 185"
Cohesion: 0.08
Nodes (24): MapTool, MapViewportApi, AddCreature(), AddCreatureProps, CreatureOption, InitiativeStrip(), InitiativeStripProps, StripCell (+16 more)
...
Cohesion: 0.06
Nodes (16): monsterInstanceName(), InitVital(), CombatantCard(), CombatWrite, EncounterStatblockModal, MonsterCard(), MonsterHpControl(), MonsterInitChip() (+8 more)
...
Cohesion: 0.10
Nodes (30): addProvenance(), applyLongRestExhaustion(), canonicalKey(), canonicalValue(), CONDITION_RULES, CONDITION_SCHEMA_CONTEXT, conformConditionIdentity(), conformConditionInstances() (+22 more)

### Community 194 - "Community 194"
Cohesion: 0.08
Nodes (31): buildCharacterPdf(), CharacterPdfExport, decodeDataUrl(), downloadCharacterPdf(), pdfFilename(), triggerDownload(), actionSummary(), buildSpellcastingVM() (+23 more)
...
Cohesion: 0.06
Nodes (32): 1. D&D Beyond, 2. Foundry VTT (core + dnd5e), 3. Roll20, 4. 5etools and Kobold+ Fight Club, 5. Homebrewery and GM Binder, 6. Baldur's Gate 3 — lookup patterns only, 7. Owlbear Rodeo — corroboration, (a) Lookup (+24 more)

### Community 197 - "Community 197"
Cohesion: 0.09
Nodes (23): DEV_PIP_EPOCHS, DEV_PIP_INIT_TABLES, devEmpty(), devEncounterInitSeed(), devPcEntry(), devPipMode, devPipScenario, encounterDemo() (+15 more)

### Community 198 - "Community 198"
Cohesion: 0.12
Nodes (32): matches(), AdversaryActionCapability, adversaryCapability(), adversaryConditionCapability(), adversaryDamageCapability(), adversaryEntity(), adversaryHealCapability(), adversaryTemplate() (+24 more)
...
Cohesion: 0.08
Nodes (22): appendPersistentCombatEffect(), applyDeclaredCombatEffects(), revokePersistentCombatEffect(), revokePersistentCombatEffectsBySource(), Locale, restoreTurnEconomy(), selectedAction(), snapshotTurnEconomy() (+14 more)

### Community 210 - "Community 210"
Cohesion: 0.11
Nodes (29): EndResult, FoldResult, EffectId, ProgramRun, RunHeld, RunOutcome, StepResult, applyConditionOverride() (+21 more)
...
Cohesion: 0.08
Nodes (23): conformCounter(), conformHomebrewDefinitionOwnerRef(), conformHomebrewDefinitionOwnerRefStructure, conformMechanicsCapabilityInstallationRef(), conformMechanicsCapabilityInstallationRefStructure, conformMechanicsCapabilityRef(), conformMechanicsCapabilityRefStructure, conformMechanicsDefinitionRef() (+15 more)
...
Cohesion: 0.09
Nodes (27): genPlayable(), seqFactory(), { catalogue }, Fake, fakeTable(), fixtureLog(), mount(), RAPIER (+19 more)

### Community 227 - "Community 227"
Cohesion: 0.09
Nodes (23): seqKey(), conditionName(), createPlayLabels(), monsterLabelId(), PlayLabelArgs, SRD_KINDS, nextMonsterOrdinal(), seatableCharacter() (+15 more)
...
Cohesion: 0.12
Nodes (23): captureScreenshot(), downscale(), Screenshot, toBlob(), buildCrashPrefill(), reportCrash(), stackHead(), openReport() (+15 more)
...
Cohesion: 0.09
Nodes (21): LiveEncounter, useLiveEncounter(), MemberCharacterRef, MemberDocState, pairKey(), resolveDevDoc(), useMemberCharacterDocs(), usePartyCombatStates() (+13 more)
...
Cohesion: 0.10
Nodes (24): arrowBundle(), book(), calligraphersSupplies(), holySymbol(), OPTION_B, parchment(), pouch(), PUBLIC_STARTING_EQUIPMENT_BY_BG (+16 more)
...
Cohesion: 0.12
Nodes (21): useRulesTextHighlight(), formatModifier(), StatCard(), StatCardProps, Tracker(), TrackerColor, TrackerProps, KIND_ICON (+13 more)
...
Cohesion: 0.07
Nodes (27): 10. Compendium lookup, 11. Homebrew authoring, 12. Sharing, 13. DM prep, 14. Encounter / initiative / combat, 15. Map / fog / tokens, 16. Handouts, 17. Notes / lore (+19 more)
...
Cohesion: 0.08
Nodes (15): loc(), BARBARIAN_7, CHAMPION_7_SENTINEL, HALFLING_ROGUE, rogue(), BASE_CUNNING_STRIKE, SUPREME_SNEAK, SHIELD_FEAT (+7 more)
...
Cohesion: 0.13
Nodes (20): CmpSeal(), TFn, FEAT_CATEGORIES, featText(), charClassOf(), charLevelOf(), effectiveClass(), featureSpec (+12 more)
...
Cohesion: 0.09
Nodes (22): FAMILY_COLORS, formatLogTime(), LogHueFamily, LogStyle, LucideGlyph, resolveLogStyle(), SLOT_FAMILY, STYLED_LOG_TYPES (+14 more)
...
Cohesion: 0.10
Nodes (15): addMonster(), beginEncounterTurns(), freezeOrder(), pcCombatant(), startEncounter(), addReinforcement(), fight(), encounter() (+7 more)
...
Cohesion: 0.08
Nodes (25): CATALOGUE_KIND_SCHEMA, CatalogueKindSchemaShape, HOMEBREW_DEFINITION_OWNER_REF_SCHEMA, HomebrewDefinitionOwnerRefSchemaShape, ID_SCHEMA, JOURNAL_ACTOR_REF_SCHEMA, MECHANICS_AUTHORITY_ANCHORS_SCHEMA, MECHANICS_CAPABILITY_INSTALLATION_REF_SCHEMA (+17 more)

### Community 275 - "Community 275"
Cohesion: 0.11
Nodes (18): reviewMechanicsIntent(), pushMechanicsPendingFrame(), authorityDefinition(), authoritySnapshot(), EmittedMechanicsTriggerEvidence, FAMILIAR, FIXED_ONE, HERO (+10 more)
...
Cohesion: 0.12
Nodes (23): ACTOR, addOccurrence(), authoredProgram(), COMPANION, condition(), effectOrigin(), ENCOUNTER_CLOCK, entityAuthority() (+15 more)

### Community 281 - "Community 281"
Cohesion: 0.11
Nodes (23): answerKeyFor(), isPerTargetAnswer(), riderAnswers(), answersOnly(), formulaOf(), freeRoll(), FreeRollContext, inputIsLive() (+15 more)
...
Cohesion: 0.10
Nodes (21): inferFeatures(), inferSpellcasting(), ABILITY_CODES, BARE_SPELL_KEYS, canonicalizeForCompare(), DERIVABLE, DerivableField, derivedFeatureIds() (+13 more)

### Community 285 - "Community 285"
Cohesion: 0.10
Nodes (18): libraryRef(), subscribeLibrary(), writeLibrary(), emit(), emitInvalid(), ENTRY, setDocMock, snapshotHandlers (+10 more)
...
Cohesion: 0.10
Nodes (13): AppRouter(), BeforeInstallPromptEvent, PWAInstallState, usePWAInstall(), ReportDialog(), ErrorBoundary, ErrorBoundaryProps, ErrorBoundaryState (+5 more)

### Community 292 - "Community 292"
Cohesion: 0.18
Nodes (23): undoConditionEvent(), setMonsterCondition(), AdversaryActionProvenance, applyAdversaryCondition(), applyAdversaryDamage(), applyAdversaryHeal(), completedCommit(), correlatedActionId() (+15 more)
...
Cohesion: 0.11
Nodes (14): DraftPortrait, MonsterEntry, MonsterPortraitPanel, PortraitCropModal, toMonsterInput(), makeEncounterMonsterSpec(), MonsterInput, setMonsterXp() (+6 more)
...
Cohesion: 0.15
Nodes (14): CompendiumBrowser(), useActiveTabScroll(), CompendiumPicker(), CompendiumPickerProps, CompendiumResultList(), ResultListProps, VirtualRowsProps, CompendiumPickerSpec (+6 more)
...
Cohesion: 0.17
Nodes (20): purgeBugReports(), compressImage(), deleteBugReportScreenshot(), deleteCampaignBanner(), deleteMonsterPortrait(), deletePortrait(), IMAGE_UPLOAD_META, portraitToDataUrl() (+12 more)

### Community 305 - "Community 305"
Cohesion: 0.13
Nodes (17): AudienceEntry, DriveContext, FrameRecord, frameRef(), freezeDeep(), INPUT_KEYS, isExactInput(), rejectedResult() (+9 more)

### Community 306 - "Community 306"
Cohesion: 0.14
Nodes (19): collectDebugContext(), DebugContext, g, parseIds(), readJson(), readLocale(), readTheme(), safeString() (+11 more)
...
Cohesion: 0.15
Nodes (18): DmDrawer(), DmDrawerProps, DRAWER_TAB_LABEL, HiddenRow, CONDITIONS, HpEdit, HpEditor(), HpEditorProps (+10 more)
...
Cohesion: 0.11
Nodes (13): CommandPalette, GlobalCombatMount, LibraryMount, ShortcutsSheet, positions, ScrollRestorer(), DevActAsDock(), DockTarget (+5 more)

### Community 325 - "Community 325"
Cohesion: 0.10
Nodes (13): potentialPcDamageTargetIds(), getSpellById(), spellIndex, spells, resolveCombatEffectGrantGroup(), resolveCombatEffectGrants(), resolveCombatEffectGrantSources(), upcastFacts() (+5 more)

### Community 326 - "Community 326"
Cohesion: 0.11
Nodes (14): browserStorage(), buildPipModel(), CombatStatusStore, GlobalCombat, overlayOpenCampaign(), PendingTurn, pickPrimaryCampaignId(), PinStore (+6 more)
...
Cohesion: 0.17
Nodes (21): isDamageType(), isSpellSchool(), isTrackerUnit(), opt(), parseCustomArmorAc(), parseCustomEquipment(), parseCustomFeature(), parseCustomSpell() (+13 more)
...
Cohesion: 0.10
Nodes (20): D10 — Landing and the campaign hub, D11 — Invite and join, D12 — Roster and its empty state, D13 — Library: create content and the editor register, D14 — Library: sharing and copies, D15 — Import and inspection, D16 — Account: profile, preferences, privacy, D17 — Cross-cutting: copy register, empty states, feedback, motion (+12 more)
...
Cohesion: 0.10
Nodes (20): ActionDocumentGuard, ActionFactGuard, ActionGuards, ActionJournal, ActionJournalRejectionReason, ActionJournalReset, ActionJournalResetResult, ActionJournalTransition (+12 more)

### Community 337 - "Community 337"
Cohesion: 0.10
Nodes (20): AppliedMechanicsOperation, GroupProposal, MechanicsEvent, MechanicsEventBase, MechanicsEventEmission, MechanicsOperationAccessFootprint, MechanicsPostEvent, MechanicsPostEventEmission (+12 more)

### Community 338 - "Community 338"
Cohesion: 0.13
Nodes (16): CONDITIONS, contrast(), css, folioCss, here, hexToRgb(), INK_TOKENS, mix() (+8 more)

### Community 339 - "Community 339"
Cohesion: 0.17
Nodes (19): createAdapterFixture(), createAuthorizedAdapterFixture(), createBootstrapFixture(), createFakeToolchain(), gitLocalEnvironmentVariables, gitLocalEnvironmentVariableSet, helperRoot, repositoryRoot (+11 more)
...
Cohesion: 0.16
Nodes (18): driveBoundary(), canonicalFingerprint, canonicalJson(), conformCanonicalFingerprint(), frozenCanonicalFingerprints, frozenCanonicalJson, requiredWord(), rotateRight() (+10 more)
...
Cohesion: 0.11
Nodes (8): attachEncounterEffects(), CharacterState, CombatHydrationPatch, D20CommandSnapshot, D20TestCommitResult, MechanicsPlanCommitResult, projectCombatHydration(), WorldVitalsCommit

### Community 349 - "Community 349"
Cohesion: 0.19
Nodes (18): readDevCampaign(), subscribeToSharedCampaigns(), makeDevPipCampaigns(), resolveDevCampaign(), browserStorage(), clearDevDocuments(), decode(), emit() (+10 more)
...
Cohesion: 0.16
Nodes (11): CreationFlow(), AuthenticatedIdentity(), IdentityNavigation(), NavigationContext, useIdentityNavigation(), IdentityWorkspace(), Workspace(), useNavigationPresentation() (+3 more)
...
Cohesion: 0.11
Nodes (12): asLocale(), Locale, LOCALES, emptySwapChoice(), isSwapIncomplete(), SpellSwapChoice, FeatAbilityPick, FeatAbilityPicker() (+4 more)

### Community 355 - "Community 355"
Cohesion: 0.20
Nodes (15): documentFor(), exactMaterialEntity(), insertResolvedMaterialResource(), locateMaterialResource(), locateResolvedMaterialResource(), MaterialResourceLocation, removeResolvedMaterialResource(), replaceResolvedMaterialResource() (+7 more)
...
Cohesion: 0.18
Nodes (18): initiativeOrder(), readyForTurns(), PlayScreen(), collectTiles(), CORE_ICON, DAMAGE_ICON, damageOf(), economyOf() (+10 more)
...
Cohesion: 0.18
Nodes (9): PLAY_REF_ANCHOR, PLAY_REF_SECTIONS, PlayRefSection, ReferenceSection(), serializeAlgorithmSteps(), ImportJSONModal(), SLOT_PATTERNS, StepSlot (+1 more)

### Community 365 - "Community 365"
Cohesion: 0.20
Nodes (15): AccountNavigation(), IdentityAccount(), IdentityWorkspaceProps, Page, accountLabel(), AccountSection, accountSections, featureDestinations (+7 more)
...
Cohesion: 0.14
Nodes (16): appendDiff(), appendMutation(), factSortKey(), isJsonObject(), journalScopeValid(), jsonEqual(), JsonObject, MechanicsActionIdentity (+8 more)
...
Cohesion: 0.14
Nodes (8): STRINGS, characterCard(), classLabel(), esc(), injectOgTags(), og_i18n_1, renderOgTags(), summarizeClasses()
...
Cohesion: 0.13
Nodes (16): ClassSorcererIcon(), FolioBurstIcon(), FolioChecklistIcon(), FolioCombatIcon(), FolioControlIcon(), FolioDangerIcon(), FolioDefendIcon(), FolioFocusIcon() (+8 more)

### Community 374 - "Community 374"
Cohesion: 0.12
Nodes (12): CATEGORIES, equipmentSpec, itemText(), EQUIP_KINDS, ItemEntry, ItemKind, ITEMS, itemsSpec (+4 more)
...
Cohesion: 0.12
Nodes (9): fireSnap(), NoteWire, parseCampaignWire(), parseDmWire(), parseRevealedWire(), PLAY_STATE, {
  setDocMock,
  updateDocMock,
  getDocMock,
  getDocsMock,
...
Cohesion: 0.15
Nodes (11): childDomainKey(), isCharacterDocValue(), parentDomainKey(), reconciledDomainEquals(), serializeCharacterEnvelope(), canonical(), canonicalJsonEquals(), CharacterSnapshotReconciler (+3 more)

### Community 389 - "Community 389"
Cohesion: 0.19
Nodes (16): CombatStateParseResult, isPlainJson(), isRecord(), KNOWN_COMBAT_STATE_KEY_MAP, KNOWN_COMBAT_STATE_KEYS, parseAppliedEncounterEffects(), parseLocText(), parsePendingConcentrationSaves() (+8 more)

### Community 390 - "Community 390"
Cohesion: 0.15
Nodes (14): abilityMod(), buildDevRosterDocs(), buildDevScenario(), buildScenario(), DEV_SCENARIOS, devPortrait(), PUBLIC_SCENARIOS, ScenarioSpec (+6 more)
...
Cohesion: 0.33
Nodes (17): attackOption(), AttackOptionUse, canAssignActions(), claimAction(), claimAttack(), claimFreeInteraction(), claimMovementRequirement(), claimReaction() (+9 more)

### Community 393 - "Community 393"
Cohesion: 0.12
Nodes (16): 0. How to read this document, 1. The three findings that decide the block, 2.1 Shell and orientation (P09), 2.2 Account (P02), 2.3 Characters: roster, creation, import (P03, P10), 2.4 Campaign (app: P02/P09 membership; mock: nine sections), 2.5 Library (P04–P08c), 2.6 At the table (mock only; the app says "not available yet") (+8 more)
...
Cohesion: 0.23
Nodes (12): EntryViewProps, CompendiumDetailBody(), CompendiumVerdict, FilterGroup, Locale, PickerCtx, PickerDetailView, PickerRowView (+4 more)
...
Cohesion: 0.14
Nodes (11): ensureUserDocument(), FirestoreUserDoc, googleProvider, initAuthListener(), signIn(), devActAsUid(), app, auth (+3 more)

### Community 411 - "Community 411"
Cohesion: 0.15
Nodes (14): decodeEnvelope(), parseCharacterEnvelope(), validateCharacterData(), ConformedFeatures, conformRaceTraitKey(), conformRaceTraitSessionIds(), matchRaceTrait(), RaceTraitMatch (+6 more)
...
Cohesion: 0.30
Nodes (16): mechanicsAuthorityDefinitionFingerprint(), entityAddressSegments(), freezePath(), materialAddressSegments(), mechanicsDefinitionFactAddress(), mechanicsInstallationFactAddress(), mechanicsResourceFactAddress(), positiveIntegerSegment() (+8 more)
...
Cohesion: 0.12
Nodes (16): advanced, common, equipment, feature, notes, origin, physical, properties (+8 more)

### Community 420 - "Community 420"
Cohesion: 0.12
Nodes (16): searchAliases, account, bestiary, campaign, characters, custom, invite, library (+8 more)
...
Cohesion: 0.23
Nodes (13): recordDirectPcEffectEvents(), appendEvent(), DistributiveOmit, mapEvent(), NewChronicleEvent, recordCondition(), recordMonsterDamage(), recordMonsterHp() (+5 more)

### Community 426 - "Community 426"
Cohesion: 0.24
Nodes (14): storedTargetCombatState(), writeCampaignCombatEffect(), parseCombatState(), defaultCombatState(), combatStateForDevWrite(), CombatStateMeta, combatStateRef(), devBypassEnabled() (+6 more)

### Community 427 - "Community 427"
Cohesion: 0.15
Nodes (12): PUBLIC_RACES, PUBLIC_RACES_WITH_PACK_GRANTS, raceFeatureEntries, RaceFeatureEntry, raceFeatureIndex, RACES_BY_ID, SRD_RACES, ExtraTrackerSpec (+4 more)
...
Cohesion: 0.13
Nodes (15): port, emulators, auth, firestore, functions, hosting, singleProjectMode, storage (+7 more)
...
Cohesion: 0.15
Nodes (12): CastLevelOption, CastRecoveryCadence, classifySpellCastingTime(), FreeCastSource, isActionCastingTime(), MasterySource, MetamagicCastOption, metamagicOptionsForCast() (+4 more)
...
Cohesion: 0.19
Nodes (10): sessionToPlayStateV1(), barbarianDoc(), charWithEquipment(), concentratingOnShieldOfFaith(), landDruid(), mockCharacter(), mockPlayState(), recordedRollCharacter() (+2 more)

### Community 438 - "Community 438"
Cohesion: 0.13
Nodes (14): bugs, homepage, license, lint-staged, *.{ts,tsx}, *.{ts,tsx,css,json,md}, name, packageManager (+6 more)

### Community 439 - "Community 439"
Cohesion: 0.13
Nodes (14): 1. The finding in one paragraph, 2.1 Narrative framing of steps, 2.2 Identity-first moments, 2.3 Live consequence previews before commit, 2.4 Language and tone: game register versus administrative register, 2.5 Feedback and micro-rewards, 2.6 Sound and motion budgets, 2.7 Expert bypass (+6 more)

### Community 440 - "Community 440"
Cohesion: 0.13
Nodes (14): 1. Owlbear Rodeo 2 extension model, 2. Talking to an external backend (our Firebase) from inside Owlbear, 3. What can be derived automatically from Owlbear scene state, 4. Existing bridges and the ecosystem, 5. Costs and risks, 6. Comparison: building a light in-app map (grid + tokens + ruler, no fog), 7. Recommendation, Architecture sketch for B (+6 more)

### Community 441 - "Community 441"
Cohesion: 0.13
Nodes (14): bio, confirmReset, confirm, details, message, title, abilityScores, expertise (+6 more)

### Community 442 - "Community 442"
Cohesion: 0.13
Nodes (14): import, error, fileTooLarge, invalidFormat, invalidJson, mustBeJson, oldFormat, success (+6 more)

### Community 443 - "Community 443"
Cohesion: 0.13
Nodes (15): actionCost, actionTip, aria, bonus, bonusCost, bonusTip, freeCost, movement (+7 more)

### Community 444 - "Community 444"
Cohesion: 0.13
Nodes (15): common, items, mine, passive, spells, dmControlled, empty, hp (+7 more)

### Community 445 - "Community 445"
Cohesion: 0.13
Nodes (15): table, add-entity, begin-turns, end, end-turn, fog, join, leave (+7 more)
...
Cohesion: 0.14
Nodes (13): 1. Narrative framing of steps, 2. Identity-first moments (name, portrait, voice — early), 3. Live consequence previews before commit, 4. Language and tone: game copy vs administrative copy, 5. Feedback and micro-rewards ("juice"), 6. Sound and motion budgets (durations, frequencies, opt-outs), 7. Expert bypass: skip, speed-up, hotkeys, "recommended", remembered choices, 8. Documented failures (what to avoid) (+5 more)
...
Cohesion: 0.16
Nodes (8): expectLegalPreset(), listAvailableForLanguageSlot(), LanguageSlotPicker(), Props, presets, presets, rolls, SEEDS

### Community 458 - "Community 458"
Cohesion: 0.18
Nodes (11): slotUsageKey(), slotResources(), buildConversionCtx(), matchingOnCastSpecs(), OnCastRefillStore, OnCastSlotRegain, OnCastSlotRegainStore, OnCastTrackerRefill (+3 more)
...
Cohesion: 0.19
Nodes (12): createBetweenTurnsEconomyState(), createEconomyState(), createTurnEconomyState(), identifier(), CHARACTER, condition(), economy(), effectWorld() (+4 more)
...
Cohesion: 0.14
Nodes (13): eldritch-mind.grants.0, description, eldritch-smite.grants.eldritch-smite, name, gaze-of-two-minds.mechanics.actions.0, description, lifedrinker.grants.lifedrinker, name (+5 more)
...
Cohesion: 0.15
Nodes (6): applyInitiativeSwaps(), sortByInitiative(), buildEncounterView(), activate(), h, published

### Community 477 - "Community 477"
Cohesion: 0.17
Nodes (10): hasActiveSpendOwner(), attunementSatisfied(), EquipRef, requiresAttunement(), potionDurationRounds(), consumableActionSlot(), resolveItemConsumable(), getMagicItem() (+2 more)
...
Cohesion: 0.19
Nodes (10): Effect, combatStateWriteData(), conditionsOf(), encodeLegacyWriteBack(), projectCombatState(), ENTITY, PREVIOUS, Write (+2 more)
...
Cohesion: 0.22
Nodes (11): campaignMapUsage(), deleteMapBackground(), MAP_UPLOAD_META, mapBackgroundPath(), mapsPrefix(), MapUploadArgs, MapUploadRefusal, MapUploadRefused (+3 more)
...
Cohesion: 0.15
Nodes (10): defineFilter(), maneuverSpec, mvText(), Slot, SLOTS, CR_BANDS, monName(), monsterProse() (+2 more)
...
Cohesion: 0.15
Nodes (12): compilerOptions, paths, tsBuildInfoFile, extends, include, @/*, @pack, @pack/item-art (+4 more)

### Community 495 - "Community 495"
Cohesion: 0.15
Nodes (12): DICE_FORMULA_VALUE_SCHEMA, POSITIVE_DISTANCE_FT_SCHEMA, STABLE_ITEM_ID_SCHEMA, WEAPON_CAPABILITIES_SCHEMA, WEAPON_CAPABILITY_SCHEMA, WEAPON_PROPERTY_SCHEMA, WEAPON_RANGE_PAIR_SCHEMA, WeaponCapabilities (+4 more)
...
Cohesion: 0.24
Nodes (11): AreaShape, cellDistance(), distanceFt(), inShape(), isAdjacent(), length(), rangeBand(), sub() (+3 more)
...
Cohesion: 0.21
Nodes (7): build(), changeClass(), downWithSession(), pickOf(), scenario(), spec(), withLevel()
...
Cohesion: 0.18
Nodes (10): (a) Reading a character sheet, (b) Spell management, (c) Inventory and equipment, (d) Level-up and growth, Documented failures — do not copy, Dominant pattern per job, (e) Character roster / "my characters" home, (f) Print / PDF and share / public sheet (+2 more)
...
Cohesion: 0.22
Nodes (8): listSharedCampaigns(), TimeoutError, withTimeout(), BulkDeleteResult, deleteCharacterAndDetach(), deleteCharactersAndDetach(), detachFrom(), SetMemberCharacter
...
Cohesion: 0.22
Nodes (7): getAllConditionIds(), build(), cache, Highlighter, highlightRulesText(), hl(), md()

### Community 539 - "Community 539"
Cohesion: 0.18
Nodes (10): 1. The document map, 2. The character parent, 3. The creation aggregates and their receipts, 4. Library entries, versions and character-owned instances, 5. The legacy `users/**` world, still live, 6. The codec (implementation contract), 7. Validation set and the migration protocol, 8. Public share links — legacy shape (+2 more)

### Community 540 - "Community 540"
Cohesion: 0.18
Nodes (10): 1. What a mechanic is on v2, 2. The authoring format, 3. The vocabulary the reducer executes today, 4. Rolls, 5. Automation levels and the DM's last word, 6. Homebrew as first-class input, 7. The E01–E22 families, 8. Undo and correction (+2 more)

### Community 541 - "Community 541"
Cohesion: 0.18
Nodes (10): 1. The lanes that exist, 2. What the unit lane is actually made of, 3. The last measured numbers, 4. The fifteen-minute target, 5. The performance budget, 6. What was deleted, and why, 7. Fixtures, 8. Three guards still read the archived v1 ledger (+2 more)
...
Cohesion: 0.20
Nodes (8): toLibraryEntry(), CUSTOM_GEAR, CUSTOM_SPELL, CUSTOM_WEAPON, entry(), persistMock, seedFullLibrary(), seedLibrary()

### Community 545 - "Community 545"
Cohesion: 0.18
Nodes (10): Blocks and dependencies, Common session contract, Coverage and sequence notes, Cross-cutting contracts, Delivery program — P01–P30, Deterministic selection of the single next block, E01–E22 assigned to P14a/b/c, Implementation depth (+2 more)

### Community 546 - "Community 546"
Cohesion: 0.38
Nodes (9): asString(), dmDisplayName(), hasValidCreatedAt(), isRecord(), isTimestampLike(), Json, plannedDateForName(), run() (+1 more)

### Community 547 - "Community 547"
Cohesion: 0.24
Nodes (7): CommandPaletteProps, CompendiumSpec, CURATED_QUICK, Glyph, Hit, getPaletteRecents(), recordPaletteRecent()

### Community 548 - "Community 548"
Cohesion: 0.18
Nodes (10): dmView, backToCampaign, noCharacterBlurb, noCharacterTitle, notAllowedBlurb, notAllowedTitle, readonly, sheetUnavailableBlurb (+2 more)

### Community 549 - "Community 549"
Cohesion: 0.18
Nodes (10): errorBoundary, backHome, details, eyebrow, message, reload, report, retry (+2 more)

### Community 550 - "Community 550"
Cohesion: 0.18
Nodes (10): canvas, token, tokenHidden, map, aria, ruler, token, label_one (+2 more)

### Community 551 - "Community 551"
Cohesion: 0.18
Nodes (11): hint, label, abbr, hint, ac, cr, slots, explain (+3 more)

### Community 552 - "Community 552"
Cohesion: 0.18
Nodes (11): verdict, crit, critTip, hit, hitTip, miss, missTip, save-fail (+3 more)

### Community 553 - "Community 553"
Cohesion: 0.18
Nodes (11): screens, admin, campaignHub, campaigns, characterCockpit, characterCreate, compendium, login (+3 more)

### Community 554 - "Community 554"
Cohesion: 0.18
Nodes (10): units, beads, charges, dice, hp, points, rounds, treats (+2 more)
...
Cohesion: 0.18
Nodes (6): BudgetedSlot, CombatState, DEFAULT_BUDGET, EconomySlot, SelectedAction, SlotBudget

### Community 563 - "Community 563"
Cohesion: 0.18
Nodes (10): CatalogueKind, HomebrewDefinitionOwnerRef, MechanicsAuthorityAnchors, MechanicsCapabilityInstallationRef, MechanicsCapabilityRef, MechanicsDefinitionRef, MechanicsInvocationRef, MechanicsRevision (+2 more)

### Community 564 - "Community 564"
Cohesion: 0.18
Nodes (10): CharacterMaterialRef, ClockRef, EntityRef, InventoryGenerationRef, MaterialEntityRef, MaterialRef, OccurrenceGenerationRef, OccurrenceRef (+2 more)
...
Cohesion: 0.18
Nodes (6): BADGES, requestFor(), falseLifeCard(), action(), Probe(), localizeActions()
...
Cohesion: 0.20
Nodes (9): 1. Step order, mandatory/optional, defaults, backtracking, timing, 2. How each choice is explained, 3. Engagement devices (non-decorative), 4. Speed for experts, 5. Progressive disclosure after creation, 6. Known criticisms — do not copy these, Baldur's Gate 3 character creation — research evidence, Patterns worth copying (observable behaviour) (+1 more)

### Community 574 - "Community 574"
Cohesion: 0.20
Nodes (9): 1. Progressive disclosure: canon and variants, 2. "Expert fast / beginner curious" — game mechanisms, 3. Onboarding a brand-new D&D player, digitally, 4. Showing consequences before commitment, 5. Engagement without decoration, 6. Length, structure, save/resume, error messaging — numbers, Progressive Disclosure & Onboarding: Evidence Base for d20 Folio, Rules for d20 Folio's creation journey (+1 more)

### Community 575 - "Community 575"
Cohesion: 0.20
Nodes (9): ADR-0004: K1 and the Wayfinder S1 are retired; the A1 topology direction is kept, Alternative 1: Grow K1 into the reducer, Alternatives Considered, Amendment (2026-09-03, `v2` architecture reset), Consequences, Context, Decision, Negative (+1 more)

### Community 576 - "Community 576"
Cohesion: 0.20
Nodes (9): ADR-0007: Test portfolio — golden replays, properties, exhaustiveness, few rules and e2e tests, Alternative 1: Keep the suite and add tests for the new engine, Alternatives Considered, Amendment (2026-09-03, `v2` architecture reset), Consequences, Context, Decision, Negative (+1 more)

### Community 577 - "Community 577"
Cohesion: 0.20
Nodes (9): ADR-0009: Every persisted-shape change migrates live data before the deploy that needs it, Alternative 1: Read-time lazy migration with compatibility readers, Alternatives Considered, Amendment (2026-09-03, `v2` architecture reset), Consequences, Context, Decision, Negative (+1 more)

### Community 578 - "Community 578"
Cohesion: 0.20
Nodes (9): ADR-NNNN: [Decision Title], Alternative 1: [Name], Alternatives Considered, Consequences, Context, Decision, Negative, Positive (+1 more)

### Community 579 - "Community 579"
Cohesion: 0.20
Nodes (10): 0.16.0, Account, admin & accessibility, Bio, features & campaign hub, Combat & encounters, Creation & level-up wizards, Inventory, Roster, shell & compendium, Spells (+2 more)

### Community 580 - "Community 580"
Cohesion: 0.29
Nodes (6): pactSlotArray(), pactSlotCount(), pactSlotLevel(), pactSlots(), WARLOCK_FEATURES, WARLOCK_TABLE

### Community 581 - "Community 581"
Cohesion: 0.31
Nodes (9): { catalogue }, dash(), endTurn(), goblinAt(), move(), opened(), ranger, run() (+1 more)

### Community 582 - "Community 582"
Cohesion: 0.33
Nodes (6): BrowserProps, EntryView(), CompendiumFacets(), FacetsProps, AnyCompendiumSpec, COMPENDIUM_SPECS

### Community 583 - "Community 583"
Cohesion: 0.20
Nodes (4): FEATS_BY_ID, PUBLIC_FEATS, SRD_FEATS, SrdFeatData

### Community 584 - "Community 584"
Cohesion: 0.27
Nodes (8): BeastStatBlock, MonsterStatBlock, BEAST_SENSE_KEYS, beastProjectionFromMonster(), BeastSenses, hasBeastSense(), MonsterSenses, pickBeastSenses()

### Community 585 - "Community 585"
Cohesion: 0.22
Nodes (8): ABILITY_CODES, setToArr(), SheetDump, spellName(), assertCoherent(), docWith(), GARBAGE, numbers()

### Community 586 - "Community 586"
Cohesion: 0.20
Nodes (7): useOverlayBack(), ModalShell(), ModalSize, ShellProps, PortraitLightbox(), Props, Dialog()
...
Cohesion: 0.27
Nodes (7): conformIntegerBindings(), conformIntegerExpression(), conformIntegerExpressionStructure, evaluate(), safe(), UNSAFE_IDS, withinComplexity()
...
Cohesion: 0.22
Nodes (9): Corroboration — Obsidian / Notion, D&D Beyond — Campaign Notes (DM notes), D&D Beyond — Game Log, Foundry VTT — Journal text pages, Job B — Session notes and recap ("what happened last time"), Kanka — Journals, Owlbear Rodeo — Journal! extension, Roll20 — Chat Archive and External Journal (+1 more)
...
Cohesion: 0.28
Nodes (8): buildBudgetView(), budgetVerdict, EncounterDifficulty, encounterXpCost(), partyXpBudget(), XP_BUDGET_PER_CHARACTER, XpBudget, xpBudgetForLevel()
...
Cohesion: 0.50
Nodes (8): commitBoundary(), endLocalEncounter(), firePassedTurnBoundaries(), observePartyWorldFights(), OpenCharacterWorld, PartyFightSnapshot, reconcileLease(), sameFight()
...
Cohesion: 0.25
Nodes (6): concentrationValue(), EngineCastFlowProps, mirrorConcentrationSwap(), buffed(), markedCaster(), warlockCaster()
...
Cohesion: 0.22
Nodes (8): Global constraints, P05 Base Homebrew Implementation Plan, Task 1 — Typed authoring and conformance, Task 2 — Character instance persistence, Task 3 — Family editors, readable preview and portable UI, Task 4 — Reuse in real sheet, Task 5 — Actual optimized runtime acceptance, Verification receipt

### Community 626 - "Community 626"
Cohesion: 0.25
Nodes (7): diceCount(), RollPanel(), RollPanelProps, RollPrompt, RollView, VERDICT_TONE, PendingInput

### Community 627 - "Community 627"
Cohesion: 0.42
Nodes (7): AttachedRef, attachedRefsOf(), hasAclResidue(), isRecord(), Json, pointerAction(), run()

### Community 628 - "Community 628"
Cohesion: 0.44
Nodes (7): asString(), hasLegacyNotes(), isRecord(), Json, legacyNoteToNoteDoc(), NoteDocData, run()
...
Cohesion: 0.22
Nodes (8): auran, name, gnoll, name, gnomish, name, goblin, name

### Community 635 - "Community 635"
Cohesion: 0.22
Nodes (8): daggers, name, martial-weapons, martial-weapons-finesse-or-light, name, name, shortbows, name
...
Cohesion: 0.28
Nodes (5): ACTION_SURGE_ACTIONS, claimAction(), claimAttackAction(), OWNER, planned()
...
Cohesion: 0.25
Nodes (8): Donjon — Fantasy Calendar generator, Fantasy Calendar (app.fantasy-calendar.com), Job F — In-world calendar, date, weather, Kanka — Calendars and reminders, Owlbear Rodeo — extensions, Seasons & Stars (Foundry v13 module), Simple Calendar (Foundry module), World Anvil — Calendars and Timelines
...
Cohesion: 0.25
Nodes (5): MONSTER_ART, monsterPortraitUrl(), publicFiles, publicMonsterArt, MonsterArtHeader()
...
Cohesion: 0.64
Nodes (7): conformActiveCombatEffects(), conformCombatEffectOp(), isActiveCombatEffect(), isCombatantRef(), isCombatEffectDuration(), isRecord(), isString()
...
Cohesion: 0.32
Nodes (8): conformMaterialEntityRef(), controllerWouldCycle(), entityCandidate(), isMaterialEntityRef(), locateMaterialEntityGeneration(), requiredCompleteTurnBoundary(), simulateEntityAvailability(), simulateEntityController()
...
Cohesion: 0.32
Nodes (7): d20, d4, d6, dieFormula(), fixed(), observationFor(), resolutionFor()
...
Cohesion: 0.29
Nodes (7): Baldur's Gate 3 — Camp and Journal as framing devices, D&D Beyond — Campaign page, Job A — Campaign home / hub ("where am I, what's next"), Kanka — Campaign dashboard, Owlbear Rodeo — Profile page and room, Roll20 — Game Details page, World Anvil — Campaign Manager

### Community 702 - "Community 702"
Cohesion: 0.29
Nodes (7): D&D Beyond, Foundry VTT, Job G — Party invitation / join and member roles, Kanka, Owlbear Rodeo, Roll20, World Anvil
...
Cohesion: 0.33
Nodes (5): applyStartingForm(), POLYMORPH_SPELL_IDS, polymorphBuildPatch(), PolymorphPrior, polymorphPriorSnapshot()
...
Cohesion: 0.29
Nodes (6): magicItemSpec, miText(), RARITIES, RARITY_CLASSES, RARITY_TONE, TYPES

### Community 725 - "Community 725"
Cohesion: 0.38
Nodes (6): CASTER_CLASSES, effectiveClass(), isCrossClass(), spellListClass(), spellSpec, spellText()
...
Cohesion: 0.38
Nodes (5): ImportError, isValidStep(), normalizeStep(), parseAlgorithmJson(), readIcon()
...
Cohesion: 0.38
Nodes (5): character(), copyLabel(), renderRail(), resourceRowLabel(), state()
...
Cohesion: 0.33
Nodes (6): Foundry VTT — Journal ownership and secret blocks, Job D — Notes and lore: NPCs, places, factions; secret vs player-visible, Kanka — private entries, visibility, posts, Owlbear Rodeo — GM Vault, notes, Roll20 — Journal, Characters, Handouts, World Anvil — Secrets and Subscriber groups

### Community 768 - "Community 768"
Cohesion: 0.33
Nodes (6): Foundry VTT — "Show Players", Job E — Handouts, images, letters shown to players; reveal / revoke, Owlbear Rodeo — GM Vault, Roll20 — "Show To Players", Simple Calendar (Foundry) — note "Show Players", World Anvil — reveal by group
...
Cohesion: 0.33
Nodes (5): SituationalRules(), buildSituationalRulesView(), RuleLineVM, SituationalRulesView, TravelPaceVM
...
Cohesion: 0.40
Nodes (5): Apollo (Discord bot) — event with RSVP, Doodle — Group Poll, Job C — Scheduling the next session, availability polls, shared calendar, Roll20 — "Next Game Will Be" and Schedule prompt, When2meet — availability grid

### Community 892 - "Community 892"
Cohesion: 0.60
Nodes (4): storedCharacterConcentration(), normalizeConcentrationRef(), normalizeLogEntryConcentration(), normalizeStoredConcentration()
...
Cohesion: 0.40
Nodes (3): emptyAggregate(), aggregateWith(), agg()
...
Cohesion: 0.40
Nodes (3): Harness(), { navigateMock, isAdminState }, setPaletteOpen

### Community 1061 - "Community 1061"
Cohesion: 0.50
Nodes (3): Documented failures — do not copy, Dominant pattern per job, Reference products — campaign jobs (evidence file)
...
Cohesion: 0.67
Nodes (3): pact-of-the-blade, description, name
...
## Knowledge Gaps
- **19239 isolated node(s):** `npx`, `schema_version`, `diagram_type`, `title`, `quality_profile` (+19234 more)
...
- **Why does `localizeSrd()` connect `Community 13` to `Community 3`, `Community 9`, `Community 16`, `Community 17`, `Community 538`, `Community 159`, `Community 38`, `Community 169`, `Community 300`, `Community 45`, `Community 54`, `Community 194`, `Community 80`, `Community 724`, `Community 725`, `Community 227`, `Community 484`, `Community 109`, `Community 374`, `Community 251`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `srdCatalogues()` connect `Community 17` to `Community 313`, `Community 587`, `Community 132`, `Community 13`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 87` to `Community 3`, `Community 516`, `Community 394`, `Community 138`, `Community 911`, `Community 16`, `Community 914`, `Community 664`, `Community 152`, `Community 159`, `Community 1313`, `Community 291`, `Community 38`, `Community 169`, `Community 170`, `Community 57`, `Community 191`, `Community 706`, `Community 1092`, `Community 1094`, `Community 73`, `Community 586`, `Community 717`, `Community 718`, `Community 208`, `Community 80`, `Community 480`, `Community 240`, `Community 121`, `Community 250`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **What connects `npx`, `schema_version`, `diagram_type` to the rest of the system?**
  _19239 weakly-connected nodes found - possible documentation gaps or missing edges._
