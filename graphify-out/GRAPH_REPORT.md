...
## Summary
- 31339 nodes · 42019 edges · 3213 communities (2621 shown, 592 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 3341 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ebb047fe`
...
## Communities (3213 total, 592 thin omitted)
...
Cohesion: 0.02
Nodes (147): AdminPage(), AdminSheet(), AdminSheetView(), LibraryMount(), SettingsPage(), useLoadExample(), AppShell(), CampaignArtControl() (+139 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (200): getBeast(), hasActiveSpendOwner(), ABILITIES, getEquipment(), getRace(), rawRaceTraitCatKey(), isPoolAltRecovery(), abilityModifier() (+192 more)
...
Cohesion: 0.02
Nodes (170): derivePartyMemberStats(), CombatHeader(), CombatResolver(), RestFlow(), dumpSheet(), LeftHud(), acFromAggregate(), aggregateCharacterGrants() (+162 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (148): label(), classFeatureIndex, classFeatures, classTableIndex, classTables, getClassTable(), getFeaturesAtLevel(), getSubclassFeatures() (+140 more)
...
Cohesion: 0.04
Nodes (97): advancedCollections(), composeOriginBuild(), useAcquisitionLabels(), AdvancedFields(), AdvancedReader(), Bestiary(), archiveKeys(), CampaignHomebrew() (+89 more)
...
Cohesion: 0.03
Nodes (111): AdvancedCollection, advancedFields(), advancedRowFields(), AdvancedRowKind, b(), blankAdvancedRow(), declaredProgramCosts(), f() (+103 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (111): commitBoundary(), commitPartyAttackParticipation(), endLocalEncounter(), firePassedTurnBoundaries(), observePartyWorldFights(), OpenCharacterWorld, PartyFightSnapshot, reconcileLease() (+103 more)
...
Cohesion: 0.03
Nodes (88): RetainedCreation, StoragePort, ImportDraft, parseImportDraft(), createImportRepository(), exactReceipt(), ImportOperation, ImportReceipt (+80 more)
...
Cohesion: 0.02
Nodes (96): CONDITION_ICONS, StatusLedge(), applyActionConcentration(), confirmConcentrationSwap(), fmt(), localizeCustom(), customConcentrationValue(), localeRangePair() (+88 more)
...
Cohesion: 0.03
Nodes (76): monsterInstanceName(), InitVital(), CombatantCard(), CombatWrite, EncounterStatblockModal, HpVital(), MonsterCard(), MonsterHpControl() (+68 more)
...
Cohesion: 0.04
Nodes (81): catalogueSnapshot(), catalogueSource(), families, leafDefinition(), creationPool(), proficientWeapon(), resolveCreationPool(), snapshots (+73 more)
...
Cohesion: 0.03
Nodes (73): MovementSlider(), MovementSliderProps, snapClamp(), EconFilterType, ThisTurnTracker(), advanceSharedTurn(), combatantUid(), observedOwnerBoundary() (+65 more)

### Community 39 - "Community 39"
Cohesion: 0.02
Nodes (93): srdArraySegment(), srdGrantSegment(), srdKey(), srdSlug(), resolveCompanion(), selectCompanionVariant(), collectGrantBundles(), AcFormula (+85 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (82): conformMechanicsAuthorityDefinition(), conformMechanicsAuthorityDefinitionStructure, conformMechanicsAuthoritySnapshot(), conformMechanicsAuthoritySnapshotStructure, definitionClosureSemantics(), definitionSemantics(), factGuardKey(), guardsAreCanonical() (+74 more)
...
Cohesion: 0.03
Nodes (46): mageDoc(), monkAtLevel(), fixture(), planned(), clericDoc(), healerDoc(), marcoDoc(), projected() (+38 more)
...
Cohesion: 0.03
Nodes (73): reviewMechanicsIntent(), beginMechanicsCausalState(), isMechanicsWorld(), parseMechanicsWorld(), validateClosedTurnState(), authorityDefinition(), authoritySnapshot(), EmittedMechanicsTriggerEvidence (+65 more)
...
Cohesion: 0.05
Nodes (84): commandFor(), GainInputs, hasCanonicalIdentity(), ItemResourceCommandPreparation, ItemResourceCommandRecipe, ItemResourceCommandRejection, PreparedItemResourceCommand, prepareItemResourceCommand() (+76 more)
...
Cohesion: 0.05
Nodes (83): advanceEncounterTurn(), appendChronicleChapter(), appendCombatEffectOp(), appendPersistentCombatEffect(), appendPersistentCombatEffectOp(), appendPersistentCombatEffectOpOptimistic(), applyDeclaredCombatEffects(), applyPersistentCombatEffectOperation() (+75 more)

### Community 56 - "Community 56"
Cohesion: 0.04
Nodes (77): EN_TO_TOKEN, enToProficiencyToken(), KNOWN_TOKENS, raceIdByName(), ABILITY_CODES, ARMOR_CATEGORIES, ArmorCategory, asString() (+69 more)
...
Cohesion: 0.05
Nodes (67): MobileDisclosure(), cn(), WhyProse(), Badge(), BadgeProps, BadgeSize, BadgeVariant, VARIANT_CLASS (+59 more)

### Community 64 - "Community 64"
Cohesion: 0.04
Nodes (41): loadPackSrdCatalogues(), HERE, I18N_ROOT, Json, mergedUi(), loadSrdCatalogues(), registerSrdCatalogues(), consult() (+33 more)

### Community 65 - "Community 65"
Cohesion: 0.06
Nodes (77): authenticReviewedIntents, bindingsFor(), canonicalResourceCandidates(), characterMaterialRef(), comparison(), compilationPredicateContext(), conformAnswersStructure, conformIntentStructure (+69 more)
...
Cohesion: 0.09
Nodes (79): conformMechanicsExecutionFrame(), dispatchMechanicsEventSubscriber(), refreshMechanicsProgramProjectedCompilationContext(), conformEntityRef(), acceptMechanicsPendingFramePhaseTransition(), advanceMechanicsPendingFrameSlot(), advanceMechanicsPendingFrameStep(), causeKey() (+71 more)
...
Cohesion: 0.08
Nodes (65): budget(), parseClassBuild(), validResourceId(), defaultPreparedState(), integer(), keys(), materializePreparedCopy(), parsePreparationVersion() (+57 more)
...
Cohesion: 0.07
Nodes (62): CreationPreview, CreationCandidate, CreationReceipt, CreationRepository, CreationValidation, receipt(), creationCandidate(), creationCatalogue() (+54 more)
...
Cohesion: 0.06
Nodes (61): auditCombatState(), auditDocument(), auditEnvelope(), auditLibrary(), auditPortableExport(), AuditVerdict, classify(), classifyPath() (+53 more)
...
Cohesion: 0.05
Nodes (51): ArmorCard, ArmorCardCallbacks, ArmorCardProps, ChargeUse(), GearCard, GearCardCallbacks, GearCardProps, damageTypeAbbr() (+43 more)
...
Cohesion: 0.04
Nodes (38): abilityMod(), applyStartingForm(), buildDevRosterDocs(), buildDevScenario(), buildScenario(), DEV_SCENARIOS, devPortrait(), PUBLIC_SCENARIOS (+30 more)
...
Cohesion: 0.05
Nodes (55): characterWorldValue(), clampedExhaustion(), omitKeys(), recoveredCharacterState(), recoveredTrackerUsed(), REST_SECONDS, restFinalizedSession(), RestWorldEntries (+47 more)

### Community 89 - "Community 89"
Cohesion: 0.07
Nodes (58): blueprintEntityKey(), causesFor(), compileMechanicsFrame(), compilerContinuation(), CompilerCoordination, compilerFiberMatches(), compilerFibers, compilerInputBinding() (+50 more)

### Community 90 - "Community 90"
Cohesion: 0.06
Nodes (57): actionFactKey(), CAUSE_CONTEXT, causeAuthorizedByPendingTop(), conformCauseStructure, conformMaterialEntityRef(), conformMaterialRef, conformMechanicsOperation(), conformMechanicsOperationCause() (+49 more)

### Community 91 - "Community 91"
Cohesion: 0.05
Nodes (43): LevelUpWizard(), FIGHTING_STYLE_PLACEHOLDERS, isFightingStylePlaceholder(), listFightingStyles(), eligibleInvocations(), invocationsKnownAt(), knownInvocationIds(), listInvocations() (+35 more)
...
Cohesion: 0.06
Nodes (36): PLAY_REF_ANCHOR, PLAY_REF_SECTIONS, PlayRefSection, PlayRefDeepLink(), ReferenceSection(), TAB_DEFS, TabBody(), TabsProvider() (+28 more)

### Community 95 - "Community 95"
Cohesion: 0.06
Nodes (54): notesCollection(), collection(), stampEffectiveAc(), AdminCampaignSummary, DEV_CHARACTER_COUNTS, DEV_USER_CHARACTERS, DevAdminUser, DevBugReport (+46 more)
...
Cohesion: 0.07
Nodes (43): CmpSeal(), defineFilter(), TFn, FEAT_CATEGORIES, featSpec, featText(), charClassOf(), charLevelOf() (+35 more)

### Community 98 - "Community 98"
Cohesion: 0.05
Nodes (33): CampaignInvite(), CreateCampaignModal(), inviteLinkFromCode(), fmtMod(), HoverTip(), useSheetExport(), useItemResourceCommands(), tipBody() (+25 more)
...
Cohesion: 0.05
Nodes (33): InputAnswer, ItemResourceCommandProvider(), PendingInput, CommittedItemResourceBoundary, CommittedItemResourceCommand, createItemResourcePaymentCycle(), ItemResourceCommandApi, ItemResourceCommandContext (+25 more)

### Community 105 - "Community 105"
Cohesion: 0.08
Nodes (47): CataloguePoolQuery, ChoiceResolutionContext, conformCataloguePool(), resolveCatalogueChoice(), ResolvedPoolOption, assertOriginJsonBudget(), baseAbilities(), baselineProofs() (+39 more)
...
Cohesion: 0.08
Nodes (42): description, name, I18N_ROOT, mergedUi(), PACK_I18N_ROOT, readShard(), shardNames(), srdCatalogue() (+34 more)
...
Cohesion: 0.10
Nodes (44): answerNumber(), answerPosition(), AreaResolution, areaShapeFrom(), adjustPacket(), applyDamage(), applyHealing(), DamageOptions (+36 more)

### Community 121 - "Community 121"
Cohesion: 0.06
Nodes (33): saves(), CR_VALUES, monsterInitiative(), monsterPassivePerception(), monsterSaveBonus(), monsterSkillBonus(), pbForCr(), XP_BY_CR (+25 more)
...
Cohesion: 0.07
Nodes (41): cellUnderFog(), DropPlan, isMapGrid(), isPositiveInt(), MapActor, MapToken, mapView, movementBudget() (+33 more)
...
Cohesion: 0.04
Nodes (45): dragonborn.traits.breath-weapon.mechanics.actions.0, description, dragonborn.traits.draconic-ancestry.grants.0.options.blue, label, dragonborn.traits.draconic-ancestry.grants.0.options.brass, label, dragonborn.traits.draconic-ancestry.grants.0.options.bronze, label (+37 more)
...
Cohesion: 0.09
Nodes (45): boundaryRulesUseCurrentAllocation(), concentrationsForTarget(), controllerWouldCycle(), documentFor(), effectiveConditionImmunities(), entityCandidate(), entityExists(), entityGenerationExists() (+37 more)
...
Cohesion: 0.09
Nodes (41): Catalogue, RollRecord, FoldResult, ActionId, EffectId, EntityId, LabelId, MechanicId (+33 more)

### Community 142 - "Community 142"
Cohesion: 0.11
Nodes (27): CreationFlow(), AccountNavigation(), IdentityAccount(), IdentityNavigation(), NavigationContext, useIdentityNavigation(), IdentityWorkspaceProps, Page (+19 more)
...
Cohesion: 0.07
Nodes (38): applyDeclaredEffectsOptimistic(), campaignMemberHpMax(), conditionEffectIdsRemovedBy(), memberCombatMax(), pcCombatantRef(), reduceDirectPcEffects(), ActiveIncomingAttackModeAdjustment, ActiveRollDieAdjustment (+30 more)

### Community 146 - "Community 146"
Cohesion: 0.08
Nodes (32): advanceTurn(), applyHp(), deadMonsterIds(), EncounterPcSeed, encounterRollFor(), finiteNumber(), hasOnlyKeys(), isEncounterMonster() (+24 more)

### Community 147 - "Community 147"
Cohesion: 0.07
Nodes (36): buildCatalogue(), CatalogueError, mechanicOf(), programOf(), conformMechanicShape, parseMechanicValue(), coverageFor(), CoverageRow (+28 more)
...
Cohesion: 0.05
Nodes (26): applyCombatToRosterDoc(), buildCharacterCache(), cacheToRosterCharacter(), cacheToRosterDoc(), CharacterCache, readCache(), RosterCharacter, RosterCharacterDoc (+18 more)
...
Cohesion: 0.09
Nodes (29): checkpointThrough(), compact(), ENCODER, encounterBytes(), pruneRolls(), shouldCompact(), throughNow(), EncounterParse (+21 more)
...
Cohesion: 0.07
Nodes (34): arePicksComplete(), ExpertiseChoicePicks, ExpertiseChoiceSlot, isExpertisePicksComplete(), pendingExpertiseSlotsForFeat(), applyFeatChoicePicks(), FeatChoicePicks, FeatChoiceSlot (+26 more)
...
Cohesion: 0.06
Nodes (38): CHARACTER_MATERIAL_REF_SCHEMA, CharacterMaterialRefSchemaShape, CLOCK_REF_SCHEMA, ClockRefSchemaShape, conformClockRef(), conformClockRefStructure, conformEntityRefStructure, conformInventoryGenerationRef() (+30 more)

### Community 158 - "Community 158"
Cohesion: 0.08
Nodes (30): castingTimeI18nKey(), CASTING_TIMES, castingTimeOption(), CustomSpellEditForm(), EngineSpellGateInput, buildFacts(), buildGloss(), buildMaterialCostTag() (+22 more)
...
Cohesion: 0.06
Nodes (14): ClassSorcererIcon(), FolioBurstIcon(), FolioChecklistIcon(), FolioCombatIcon(), FolioControlIcon(), FolioDangerIcon(), FolioDefendIcon(), FolioFocusIcon() (+6 more)
...
Cohesion: 0.10
Nodes (29): FORBIDDEN, KERNEL_DIR, MODULE_DIRS, opened(), initialState(), { catalogue }, goblin, intent() (+21 more)
...
Cohesion: 0.09
Nodes (35): hasSrd(), localizeSrd(), monsterProse(), descriptionSearch(), combatHigherLevels(), ABILITY_CODES, ABILITY_LABELS, advancementContext() (+27 more)
...
Cohesion: 0.07
Nodes (27): seqKey(), AddCreature(), AddCreatureProps, CreatureOption, conditionName(), createPlayLabels(), monsterLabelId(), PlayLabelArgs (+19 more)
...
Cohesion: 0.12
Nodes (31): allocationInvariant(), applyBinaryDefenses(), applyFlatAdjustments(), canonicalAllocation(), canonicalSubset(), conformAllocationsStructure, conformComputationStructure, conformDamageAllocationObservations() (+23 more)
...
Cohesion: 0.06
Nodes (34): description, devDependencies, eslint, @eslint/js, @types/nodemailer, typescript, typescript-eslint, vitest (+26 more)
...
Cohesion: 0.09
Nodes (25): MapTool, InitiativeStrip(), InitiativeStripProps, StripCell, initiativeOrder(), readyForTurns(), Aiming, ALLY_KINDS (+17 more)
...
Cohesion: 0.10
Nodes (32): BoundaryKind, exactBoundary(), factKey(), ItemResourceBoundaryFact, ItemResourceBoundaryInputRequest, ItemResourceBoundaryPreparation, ItemResourceBoundaryRejection, ItemResourceBoundaryReplayPreparation (+24 more)
...
Cohesion: 0.11
Nodes (27): EndResult, RunHeld, StepResult, isCoord(), isMapCell(), EventSelector, applyConditionOverride(), applyOverride() (+19 more)
...
Cohesion: 0.13
Nodes (28): ABILITY_SET, abilityOf(), ADJACENT_TARGET, areaSpec(), attackProgram(), CharacterSeat, CORE_COVERED_ROWS, costsFor() (+20 more)
...
Cohesion: 0.09
Nodes (14): BYSTANDER, CARRIED, { catalogue }, encounterFromReplay(), LogEntry, populatedFoldedState(), Replay, REPLAY_DIR (+6 more)
...
Cohesion: 0.10
Nodes (22): createEmptyCharacterMaterialState(), createEmptySharedMaterialState(), shared(), CHARACTER, count(), SELF, state(), world() (+14 more)
...
Cohesion: 0.07
Nodes (26): archelon, name, attack.beak, name, attack.fist, name, attack.sting, name (+18 more)
...
Cohesion: 0.10
Nodes (19): potentialPcDamageTargetIds(), getSpellById(), matchingOnCastSpecs(), OnCastRefillStore, OnCastSlotRegain, OnCastSlotRegainStore, OnCastTrackerRefill, resolveOnCastSlotRegain() (+11 more)
...
Cohesion: 0.14
Nodes (22): { catalogue }, DM, fogged(), P1, P2, run(), table(), applyAll() (+14 more)
...
Cohesion: 0.14
Nodes (25): catalogueDefault(), counterFromCharges(), counterFromTracker(), createItemInstanceId(), isItemInstanceId(), isRecord(), isWhole(), ItemInstanceIdFactory (+17 more)
...
Cohesion: 0.14
Nodes (18): CONTENT_PACK_ENTRY, CONTENT_PACK_ITEM_ART_ENTRY, CONTENT_PACK_MONSTER_ART_ENTRY, CONTENT_PACK_MONSTERS_ENTRY, contentPackEnabled(), fsAllowRoots(), PACK_EMPTY_ENTRY, packAliasTarget() (+10 more)
...
Cohesion: 0.11
Nodes (14): i18nReady, AuthenticatedIdentity(), IdentityApp(), IdentityBoundary, IdentityWorkspace(), SharedAssignment(), Draft, useClassBuild() (+6 more)

### Community 287 - "Community 287"
Cohesion: 0.10
Nodes (18): asLocale(), Locale, LOCALES, FeatAbilityPick, FeatAbilityPicker(), Props, CLASS_ROLE_FALLBACK, CLASS_ROLE_IDS (+10 more)
...
Cohesion: 0.13
Nodes (22): actionInput(), AttackCastPlan, authorityDefinition(), authorityReceipt(), authoritySnapshot(), CASCADE_PROGRAM, causalState(), conformed() (+14 more)
...
Cohesion: 0.12
Nodes (13): reduceCampaignCombatMutation(), storedCharacterLifecycleEligible(), clampTemp(), HpAfterDamage, applyCombatToSession(), CombatSessionHydrationResult, initiativeToString(), mergeCombatTrio() (+5 more)
...
Cohesion: 0.12
Nodes (20): { catalogue }, EN, encounterOf(), GOBLIN, HERO, IT, lines(), MARCO (+12 more)
...
Cohesion: 0.09
Nodes (20): ImportFlow(), firestore, rules, functions, hosting, headers, ignore, public (+12 more)
...
Cohesion: 0.10
Nodes (13): reducePersistentMonsterDamage(), applyInitiativeSwaps(), sortByInitiative(), buildEncounterView(), EncounterBudgetView, EncounterCombatantView, EncounterView, monsterDamageDefenses() (+5 more)
...
Cohesion: 0.13
Nodes (13): DraftPortrait, MonsterEntry, MonsterPortraitPanel, PortraitCropModal, customMonsterToInput(), toMonsterInput(), makeEncounterMonsterSpec(), MonsterInput (+5 more)
...
Cohesion: 0.23
Nodes (19): dueAt(), endEffects(), hideRect(), isMapBackground(), isMapRect(), revealRect(), addEntity(), applyTable() (+11 more)
...
Cohesion: 0.15
Nodes (13): useRealmBackdrop(), BulkStatusResult, setCharactersStatus(), ImportJsonButton(), RosterBulkBar(), RosterBulkBarProps, RosterPage(), RosterBulkAction (+5 more)
...
Cohesion: 0.13
Nodes (14): conformMechanicsProgramAuthorityReceipt(), conformMechanicsProgramAuthorityReceiptStructure, EntityInstallationOwner, InstallationOwner, isEntityActor(), mechanicsProgramAuthorityReceiptFingerprint(), MechanicsProgramAuthorityReceiptSchemaRefTypes, receiptSemantics() (+6 more)
...
Cohesion: 0.13
Nodes (18): asAction(), cast(), casterDoc(), { catalogue }, FIREBALL, GOBLIN_A, GOBLIN_B, MARCO (+10 more)
...
Cohesion: 0.13
Nodes (15): getClassFeatures(), allowedSpellListsForSlot(), applySpellChoicePicks(), bestAbility(), listAvailableForSlot(), pendingSpellChoicesForFeat(), savantSpellEntitlement(), SpellChoiceCtx (+7 more)
...
Cohesion: 0.15
Nodes (13): LongPressHandlers, useLongPress(), UseLongPressOptions, CharacterCard(), CharacterCardProps, CharacterCardSelection, Division, DIVISIONS (+5 more)
...
Cohesion: 0.17
Nodes (15): advancePulse(), AUTHORED_SPELL_IDS, authorityReceipt(), castAuthored(), drive(), DriveScript, HERO, heroState() (+7 more)
...
Cohesion: 0.17
Nodes (15): ConcentrationSavePrompt(), CharacterConcentrationSaveD20Context, CharacterD20ContextBase, CharacterD20ModifierTerm, CharacterD20TestContext, CharacterDeathSaveD20Context, CharacterEnteredD20Result, CharacterReviewedD20Outcome (+7 more)

### Community 406 - "Community 406"
Cohesion: 0.16
Nodes (14): CreationWizard(), isSpellChoicesComplete(), ChoicePicks, EMPTY_CHOICE_PICKS, FeatureChoiceSlots, hasAnyChoiceSlots(), partitionChoiceSlotsBySource(), pruneChoicePicks() (+6 more)
...
Cohesion: 0.12
Nodes (14): BACKGROUND_NAMES, backgroundNameById(), CLASS_NAMES, classNameById(), NamedEntry, PUBLIC_BACKGROUND_NAMES, PUBLIC_CLASS_NAMES, PUBLIC_RACE_NAMES (+6 more)
...
Cohesion: 0.15
Nodes (12): ApplyProbe(), currentDoc(), firstOption(), log(), mount(), S, sneakUsed(), spec (+4 more)
...
Cohesion: 0.12
Nodes (13): BreakdownLine, BreakdownLineExtras, BreakdownNote, BreakdownPartExtras, BreakdownWhy, BreakdownWhyLine, RawBreakdownPart, PASSIVES (+5 more)
...
Cohesion: 0.23
Nodes (14): collectTiles(), CORE_ICON, DAMAGE_ICON, damageOf(), economyOf(), GROUP_ICON, groupOf(), hotbarTiles() (+6 more)
...
Cohesion: 0.18
Nodes (9): applyLanguagePicks(), isLanguageId(), LANGUAGE_IDS, LanguageChoicePicks, LanguageChoiceSlot, listAvailableForLanguageSlot(), pendingLanguageSlotsForFeat(), LanguageSlotPicker() (+1 more)
...
Cohesion: 0.25
Nodes (9): attack(), { catalogue }, foe, hero, logOnly(), manualRoll(), moveTo(), seq (+1 more)
...
Cohesion: 0.24
Nodes (5): ImportCharacterHost(), rosterToast(), CharacterImport, useCharacterImport(), RosterActions
...
Cohesion: 0.28
Nodes (5): expectLegalPreset(), presets, presets, rolls, SEEDS
...
Cohesion: 0.22
Nodes (8): martial-weapons, martial-weapons-finesse-or-light, name, name, pact-weapon, name, shortbows, name
...
Cohesion: 0.33
Nodes (5): BEASTS, BEAST_INDEX, BEASTS, beastsByMaxCR(), resolvePolymorphForms()
...
Cohesion: 0.52
Nodes (6): creatureVitalsFor(), directConditionInstances(), documentFor(), projectEntityConditions(), projectResolvedEntityConditions(), resolvedEntityConditions()

### Community 679 - "Community 679"
Cohesion: 0.33
Nodes (7): conformDamageDefenseProfile(), conformDefenseProfileStructure, selectEffectiveConditionImmunities(), selectEffectiveDamageDefenseProfile(), selectItemActivations(), selectStandingFacts(), effectiveVitalityDefenseProfile()
...
Cohesion: 0.33
Nodes (5): ConformedFeatures, matchRaceTrait(), RaceTraitMatch, remapSessionTrackerIds(), TrackerState

### Community 746 - "Community 746"
Cohesion: 0.33
Nodes (4): applyExpertisePicks(), EXPERTISE_FEATURE_IDS, listExpertiseEligibleSkills(), applyExpertiseChoicePicks()
...
Cohesion: 0.50
Nodes (4): canonicalDamageDefenseRule(), conformDamageDefenseRule(), conformDefenseRuleStructure, damageDefenseSelector()
...
Cohesion: 0.67
Nodes (3): IconPicker(), ALGO_ICONS, resolveAlgoIcon()
...
Cohesion: 0.50
Nodes (3): Props, SrdOption, SrdTagPicker()
...
## Knowledge Gaps
- **19003 isolated node(s):** `npx`, `schema_version`, `diagram_type`, `title`, `quality_profile` (+18998 more)
...
- **Why does `localizeSrd()` connect `Community 167` to `Community 3`, `Community 387`, `Community 4`, `Community 135`, `Community 519`, `Community 9`, `Community 10`, `Community 27`, `Community 158`, `Community 38`, `Community 39`, `Community 1065`, `Community 302`, `Community 48`, `Community 178`, `Community 326`, `Community 200`, `Community 857`, `Community 97`, `Community 374`, `Community 2550`, `Community 121`, `Community 1022`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `mergedUi()` connect `Community 64` to `Community 312`, `Community 115`, `Community 675`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `srdCatalogues()` connect `Community 135` to `Community 316`, `Community 15`, `Community 566`, `Community 167`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **What connects `npx`, `schema_version`, `diagram_type` to the rest of the system?**
  _19003 weakly-connected nodes found - possible documentation gaps or missing edges._
