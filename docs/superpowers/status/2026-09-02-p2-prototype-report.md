...
| `src/data/combat/prototype-catalogue.ts`                                             | six mechanics authored purely as data: longbow, shortsword (+ opportunity attack), goblin scimitar, Hunter's Mark, Shield, a Tasha's-shaped save spell |
