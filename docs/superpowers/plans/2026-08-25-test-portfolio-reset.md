...
| R0      | Authenticated edits persist once and survive reload/offline/rebase                         | Automation Wayfinder persistence seam                    | real Auth + Firestore emulator browser journeys; L2/L3                            | save/reload, server echo without a second write, Firestore SDK pending write, conflict/rebase/error |
...
| R1      | ActionFlow completes the real high-frequency jobs                                          | both Wayfinders                                          | 10-12 semantic browser journeys; L3                                               | cast, attack/save observation, resource use, rest, undo, onboarding/import                          |
...
| O1              | `creation-domain.test.ts`, authenticated create spec                                        | `pnpm exec vitest run --project fast tests/unit/creation-domain.test.ts`                                                        |
