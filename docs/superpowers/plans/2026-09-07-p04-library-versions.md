...
provides load/list/readVersion/saveIntent/offerIntent/acceptIntent/revokeIntent/commit/reconcile.
...
- [ ] Implement strict common codec and immutable version/copy/instance seams; rerun green.
